...
- Usage bars now warn as provider limits approach ([#2322](https://github.com/CodiusAI/codius-app/pull/2322) by [@cleiter](https://github.com/cleiter))
- Oh My Pi advisor results now retain their structure and severity ([#2219](https://github.com/CodiusAI/codius-app/pull/2219) by [@ebg1223](https://github.com/ebg1223))
...
- Edit files directly in the web and desktop apps ([#2270](https://github.com/CodiusAI/codius-app/pull/2270), [#2309](https://github.com/CodiusAI/codius-app/pull/2309))
- Switch models from the Command Center for active agents and new drafts ([#2147](https://github.com/CodiusAI/codius-app/pull/2147) by [@kedrzu](https://github.com/kedrzu))
- Configure workspace service ports with a fixed range or external allocator ([#2165](https://github.com/CodiusAI/codius-app/pull/2165) by [@mcowger](https://github.com/mcowger))
- Search keyboard shortcuts by action, note, or key combination ([#2160](https://github.com/CodiusAI/codius-app/pull/2160))
- Turn thinking off for supported Claude models ([#2257](https://github.com/CodiusAI/codius-app/pull/2257))
- Use Pi's Max thinking level ([#2267](https://github.com/CodiusAI/codius-app/pull/2267) by [@ByteTrue](https://github.com/ByteTrue))
...
- Idle agents release processes automatically and resume when needed ([#2203](https://github.com/CodiusAI/codius-app/pull/2203), [#2209](https://github.com/CodiusAI/codius-app/pull/2209))
- New Claude and Codex agents default to safer automatic approval modes when supported ([#2213](https://github.com/CodiusAI/codius-app/pull/2213))
- Oh My Pi now supports Max thinking in imported and new sessions ([#2191](https://github.com/CodiusAI/codius-app/pull/2191) by [@mvanhorn](https://github.com/mvanhorn))
- Commit history now includes recent pushed and base-branch commits ([#2312](https://github.com/CodiusAI/codius-app/pull/2312))
- Permission and thinking changes made during a turn now show when they take effect ([#2201](https://github.com/CodiusAI/codius-app/pull/2201))

### Fixed

- Reused branches no longer attach an unrelated merged or closed pull request ([#2172](https://github.com/CodiusAI/codius-app/pull/2172) by [@nllptrx](https://github.com/nllptrx))
- Pi compaction waits for long summaries instead of reporting a false timeout ([#2181](https://github.com/CodiusAI/codius-app/pull/2181) by [@jasonhnd](https://github.com/jasonhnd))
- Pi chats keep new messages aligned with the correct history after an idle agent resumes ([#2313](https://github.com/CodiusAI/codius-app/pull/2313))
- OpenCode follow-ups triggered by completed background work now remain visible ([#2258](https://github.com/CodiusAI/codius-app/pull/2258))
- Codex no longer shows the parent agent as a phantom subagent ([#2214](https://github.com/CodiusAI/codius-app/pull/2214))
- Local dictation now works in Nix-packaged installations ([#1587](https://github.com/CodiusAI/codius-app/pull/1587) by [@yhori991](https://github.com/yhori991))
- The composer remains visible after submitting dictated text and returning to the app ([#2194](https://github.com/CodiusAI/codius-app/pull/2194))
- Desktop's dictation shortcut remains responsive after finishing a recording ([#2268](https://github.com/CodiusAI/codius-app/pull/2268))
- Projects can be renamed before their first workspace ([#2252](https://github.com/CodiusAI/codius-app/pull/2252) by [@albertodeago](https://github.com/albertodeago))
- Settings keep showing a connected remote host when the local daemon is stopped ([#1749](https://github.com/CodiusAI/codius-app/pull/1749) by [@dwyanewang](https://github.com/dwyanewang))
- Pinned workspaces no longer disappear briefly when reopening the compact sidebar ([#2210](https://github.com/CodiusAI/codius-app/pull/2210))
- Session imports find older matches from the current workspace ([#2265](https://github.com/CodiusAI/codius-app/pull/2265) by [@nikuscs](https://github.com/nikuscs))

## 0.2.0-beta.1 - 2026-07-17

### Added

- Work with pull requests and merge requests from GitLab, Gitea, Forgejo, and Codeberg ([#1913](https://github.com/CodiusAI/codius-app/pull/1913) by [@nllptrx](https://github.com/nllptrx))
- Use Oh My Pi as a native agent provider ([#2067](https://github.com/CodiusAI/codius-app/pull/2067) by [@ebg1223](https://github.com/ebg1223))
- Browse branch commit history and open individual commit diffs from Changes ([#1534](https://github.com/CodiusAI/codius-app/pull/1534), [#2146](https://github.com/CodiusAI/codius-app/pull/2146) by [@adradr](https://github.com/adradr))
- Open workspace files in more installed editors and file managers ([#2119](https://github.com/CodiusAI/codius-app/pull/2119))
- Remove individual custom providers from Settings ([#1951](https://github.com/CodiusAI/codius-app/pull/1951))

### Improved

- ACP provider catalog updated to the latest registry versions
- Workspace focus mode stays confined to the active workspace with a visible exit control ([#2151](https://github.com/CodiusAI/codius-app/pull/2151))
- Desktop installs the newest available update instead of a cached older release ([#2149](https://github.com/CodiusAI/codius-app/pull/2149))
- Remote daemon update failures now show specific recovery steps ([#2120](https://github.com/CodiusAI/codius-app/pull/2120))
- Agent history errors now appear immediately instead of after a timeout ([#2124](https://github.com/CodiusAI/codius-app/pull/2124))

### Fixed

- Terminal panes no longer remain at 80x24 after focus or visibility changes ([#2059](https://github.com/CodiusAI/codius-app/pull/2059), [#2154](https://github.com/CodiusAI/codius-app/pull/2154) by [@cleiter](https://github.com/cleiter))
- Sign-in popups in the desktop browser now complete successfully ([#2137](https://github.com/CodiusAI/codius-app/pull/2137))
- Browser typing and shortcuts no longer submit the active Codius prompt ([#1982](https://github.com/CodiusAI/codius-app/pull/1982))
- Agent browser tabs remain controllable after switching workspaces ([#2156](https://github.com/CodiusAI/codius-app/pull/2156))
- Archived workspaces now show the correct Unarchive or Restore action ([#2002](https://github.com/CodiusAI/codius-app/pull/2002))
- Archived sessions can be reimported into the current workspace ([#2123](https://github.com/CodiusAI/codius-app/pull/2123))
- Browser shortcuts no longer appear where browser tabs are unavailable ([#2116](https://github.com/CodiusAI/codius-app/pull/2116) by [@jasonhnd](https://github.com/jasonhnd))

## 0.1.110 - 2026-07-16

### Fixed

- Kimi and other ACP agents now stay marked as running while a response is actively streaming ([#2148](https://github.com/CodiusAI/codius-app/pull/2148))
...
- Codius no longer gets stuck connecting or loses native window controls after updating ([#2111](https://github.com/CodiusAI/codius-app/pull/2111) by [@cleiter](https://github.com/cleiter))

## 0.1.108 - 2026-07-16

### Added

- Create a new project folder or clone a GitHub repository from Add Project ([#1331](https://github.com/CodiusAI/codius-app/pull/1331), [#2045](https://github.com/CodiusAI/codius-app/pull/2045), [#2097](https://github.com/CodiusAI/codius-app/pull/2097) by [@mcowger](https://github.com/mcowger))
- Search for and open workspaces from the search menu ([#2096](https://github.com/CodiusAI/codius-app/pull/2096))
- Pin workspaces to the top of the sidebar ([#1981](https://github.com/CodiusAI/codius-app/pull/1981) by [@half144](https://github.com/half144))
- Summarize tool calls in a single collapsed item with a new appearance setting ([#2031](https://github.com/CodiusAI/codius-app/pull/2031), [#2069](https://github.com/CodiusAI/codius-app/pull/2069), [#2090](https://github.com/CodiusAI/codius-app/pull/2090) by [@mcowger](https://github.com/mcowger))
- Save browser cookies and site data across tabs and restarts ([#2089](https://github.com/CodiusAI/codius-app/pull/2089))
- Claude and Codex subagents now show their actual names, with a new option to archive finished Claude Code, Codex, and OpenCode subagents ([#2073](https://github.com/CodiusAI/codius-app/pull/2073))
- Fork chats from failed turns ([#2063](https://github.com/CodiusAI/codius-app/pull/2063))

### Improved

- Permission modes have clearer icons ([#1980](https://github.com/CodiusAI/codius-app/pull/1980) by [@cleiter](https://github.com/cleiter))
- Desktop stays usable in narrower windows ([#1983](https://github.com/CodiusAI/codius-app/pull/1983))
- Sidebar controls stay in place when desktop panels open and close ([#2078](https://github.com/CodiusAI/codius-app/pull/2078))
- Typing in long drafts is smoother ([#2086](https://github.com/CodiusAI/codius-app/pull/2086))
- Codex terminal commands always appear in chat, even when they have no output ([#2037](https://github.com/CodiusAI/codius-app/pull/2037))

### Fixed

- New Workspace keeps your prompt and attachments when you switch projects or hosts ([#2030](https://github.com/CodiusAI/codius-app/pull/2030), [#2036](https://github.com/CodiusAI/codius-app/pull/2036))
- OpenCode sessions close without crashing Codius ([#2027](https://github.com/CodiusAI/codius-app/pull/2027) by [@mcowger](https://github.com/mcowger))
- Pi slash commands no longer leave chats stuck as running ([#2066](https://github.com/CodiusAI/codius-app/pull/2066) by [@ebg1223](https://github.com/ebg1223))
- Background-agent updates now appear after the main reply ([#2058](https://github.com/CodiusAI/codius-app/pull/2058) by [@1254087415](https://github.com/1254087415))
- Codex subagents no longer disappear from the Subagents track ([#2068](https://github.com/CodiusAI/codius-app/pull/2068))
- Forked chats open ready to edit in their new tab ([#2038](https://github.com/CodiusAI/codius-app/pull/2038))
- Codius opens normally after an interrupted shutdown ([#1962](https://github.com/CodiusAI/codius-app/pull/1962))
- Keyboard shortcuts now work with `-`, `=`, `;`, and `'` ([#2047](https://github.com/CodiusAI/codius-app/pull/2047) by [@OnCloud125252](https://github.com/OnCloud125252))
- Codebuddy Code models now appear in the model picker ([#1979](https://github.com/CodiusAI/codius-app/pull/1979) by [@park0er](https://github.com/park0er))
- Workspace search now includes OpenCode commands and workflows ([#2049](https://github.com/CodiusAI/codius-app/pull/2049))
- Nix installations now include the Codius web app ([#1978](https://github.com/CodiusAI/codius-app/pull/1978) by [@liamdiprose](https://github.com/liamdiprose))

## 0.1.107 - 2026-07-13

### Added

- Inspect provider-created subagents and their live conversations from the Subagents track ([#2013](https://github.com/CodiusAI/codius-app/pull/2013) by [@omercnet](https://github.com/omercnet))
- Fork chats with every supported agent provider ([#2022](https://github.com/CodiusAI/codius-app/pull/2022))

### Improved

- Add projects directly from New Workspace when none are configured ([#2026](https://github.com/CodiusAI/codius-app/pull/2026))
- New terminals open at the correct size immediately ([#2023](https://github.com/CodiusAI/codius-app/pull/2023) by [@cleiter](https://github.com/cleiter))
- Sidebar footer actions now explain themselves with tooltips ([#2025](https://github.com/CodiusAI/codius-app/pull/2025))
- Codex shell tool calls show only the command being run ([#2029](https://github.com/CodiusAI/codius-app/pull/2029))
- Custom ACP providers keep file and terminal work in the agent environment by default ([#2024](https://github.com/CodiusAI/codius-app/pull/2024))
- ACP provider catalog updated to the latest registry versions

### Fixed

- Large tables no longer make iOS chats unresponsive
- Chat controls remain clickable near the scroll-to-bottom button ([#2007](https://github.com/CodiusAI/codius-app/pull/2007))
- Oversized tool output no longer slows or floods chat timelines ([#2020](https://github.com/CodiusAI/codius-app/pull/2020))
- Cross-provider subagents can use providers without mode settings ([#2000](https://github.com/CodiusAI/codius-app/pull/2000) by [@githubbzxs](https://github.com/githubbzxs))
- Pi's internal metadata tasks no longer clutter normal session history ([#1999](https://github.com/CodiusAI/codius-app/pull/1999) by [@githubbzxs](https://github.com/githubbzxs))
- Pi chats remain usable after canceling extension commands ([#2019](https://github.com/CodiusAI/codius-app/pull/2019))

## 0.1.106 - 2026-07-12

### Added

- Approve Codex MCP permission requests in Codius ([#2001](https://github.com/CodiusAI/codius-app/pull/2001))
...
- Reduced mobile chat freezes and blank screens when switching workspaces while agents are streaming ([#1989](https://github.com/CodiusAI/codius-app/pull/1989))
- OpenCode sessions start reliably instead of occasionally losing the first turn ([#2015](https://github.com/CodiusAI/codius-app/pull/2015) by [@mcowger](https://github.com/mcowger))
- Switching between workspaces no longer flashes a white screen
- Pi keeps your existing MCP tools and settings when Codius adds its own ([#1990](https://github.com/CodiusAI/codius-app/pull/1990) by [@mcowger](https://github.com/mcowger))

## 0.1.105 - 2026-07-10

### Added

- Browse changed files as a collapsible folder tree or flat list ([#1918](https://github.com/CodiusAI/codius-app/pull/1918), [#1945](https://github.com/CodiusAI/codius-app/pull/1945) by [@cleiter](https://github.com/cleiter))
- Always expand agent reasoning with a new appearance setting ([#1943](https://github.com/CodiusAI/codius-app/pull/1943) by [@mcowger](https://github.com/mcowger))

### Improved

- Project picker finds folders with fuzzy search and native desktop browsing ([#1968](https://github.com/CodiusAI/codius-app/pull/1968))
- Large workspace sidebars stay responsive ([#1966](https://github.com/CodiusAI/codius-app/pull/1966))
- Generated workspace names and Git text can use MiniMax M3 ([#1955](https://github.com/CodiusAI/codius-app/pull/1955) by [@octo-patch](https://github.com/octo-patch))
- Cursor now exposes thinking and fast mode ([#1952](https://github.com/CodiusAI/codius-app/pull/1952))

### Fixed

- Codex stays active and streams correctly while subagents run ([#1967](https://github.com/CodiusAI/codius-app/pull/1967))
- Android audio interruptions no longer crash voice mode or leave dictation stuck ([#1941](https://github.com/CodiusAI/codius-app/pull/1941))
- Mobile sidebars stay in sync and retain swipe-to-open gestures ([#1953](https://github.com/CodiusAI/codius-app/pull/1953), [#1976](https://github.com/CodiusAI/codius-app/pull/1976))
- Pi text-only models accept image prompts without breaking the session ([#1960](https://github.com/CodiusAI/codius-app/pull/1960))
- App render failures show a retryable recovery screen instead of a blank screen ([#1924](https://github.com/CodiusAI/codius-app/pull/1924))
- Pi context usage remains visible with older Oh My Pi versions ([#1886](https://github.com/CodiusAI/codius-app/pull/1886) by [@theslava](https://github.com/theslava))
- Provider usage popovers no longer error when opened and closed quickly ([#1885](https://github.com/CodiusAI/codius-app/pull/1885) by [@theslava](https://github.com/theslava))
- Mobile workspace menus hide desktop-only shortcut badges ([#1964](https://github.com/CodiusAI/codius-app/pull/1964))

## 0.1.104 - 2026-07-08

### Added

- Agents can drive the in-app browser with page snapshots, trusted input, dialogs, and tab controls ([#1881](https://github.com/CodiusAI/codius-app/pull/1881))
- Inspect, annotate, and send page elements from a browser tab to the agent ([#1708](https://github.com/CodiusAI/codius-app/pull/1708) by [@huiliaoning](https://github.com/huiliaoning))
- Schedules screen to create and manage recurring agents ([#1246](https://github.com/CodiusAI/codius-app/pull/1246))
- Open a project from anywhere with Cmd+O ([#1849](https://github.com/CodiusAI/codius-app/pull/1849))
- Agents can rename workspaces after they understand the task ([#1876](https://github.com/CodiusAI/codius-app/pull/1876))
- Claude Ultra Code is available for supported Claude models ([#1872](https://github.com/CodiusAI/codius-app/pull/1872))
- ByteDance TRAE CLI available as an agent provider ([#1831](https://github.com/CodiusAI/codius-app/pull/1831), [#1896](https://github.com/CodiusAI/codius-app/pull/1896) by [@park0er](https://github.com/park0er))

### Improved

- Manage the built-in daemon from one place in desktop settings ([#1938](https://github.com/CodiusAI/codius-app/pull/1938))
- Scheduled and loop runs each get their own workspace in the sidebar ([#1909](https://github.com/CodiusAI/codius-app/pull/1909), [#1934](https://github.com/CodiusAI/codius-app/pull/1934))
- Large provider and model refreshes load faster in the app ([#1895](https://github.com/CodiusAI/codius-app/pull/1895))
- Workspaces created by agents now get readable generated names ([#1887](https://github.com/CodiusAI/codius-app/pull/1887))
- Browser tabs opened by agents stay in the background until you switch to them ([#1875](https://github.com/CodiusAI/codius-app/pull/1875))
- Clearer cards when an agent asks a question ([#1643](https://github.com/CodiusAI/codius-app/pull/1643) by [@cleiter](https://github.com/cleiter))
- Diagnostic reports include desktop app logs ([#1914](https://github.com/CodiusAI/codius-app/pull/1914))
- Codius's built-in tools take less context ([#1939](https://github.com/CodiusAI/codius-app/pull/1939))
...
- Composer autocomplete stays open after switching screens ([#1851](https://github.com/CodiusAI/codius-app/pull/1851))
- Claude usage appears when a quota window has no scheduled reset ([#1855](https://github.com/CodiusAI/codius-app/pull/1855))
- New workspace action shows for non-git projects in the sidebar ([#1857](https://github.com/CodiusAI/codius-app/pull/1857) by [@cleiter](https://github.com/cleiter))

## 0.1.103 - 2026-07-01

### Added

- Claude Sonnet 5 is available in the Claude model picker ([#1850](https://github.com/CodiusAI/codius-app/pull/1850))

## 0.1.102 - 2026-06-30

### Added

- Fork chats into a new tab or new worktree ([#1788](https://github.com/CodiusAI/codius-app/pull/1788))
- See workspaces from all connected hosts ([#1538](https://github.com/CodiusAI/codius-app/pull/1538), [#1775](https://github.com/CodiusAI/codius-app/pull/1775), [#1825](https://github.com/CodiusAI/codius-app/pull/1825))
- Daemon can now serve the web UI ([#1635](https://github.com/CodiusAI/codius-app/pull/1635), [#1739](https://github.com/CodiusAI/codius-app/pull/1739))
- Run Codius from an official Docker image ([#1740](https://github.com/CodiusAI/codius-app/pull/1740) by [@Herbrant](https://github.com/Herbrant))
- Update a daemon remotely from the app ([#1513](https://github.com/CodiusAI/codius-app/pull/1513) by [@thedavidweng](https://github.com/thedavidweng))
- Configure separate OpenAI endpoints for speech-to-text and text-to-speech ([#1823](https://github.com/CodiusAI/codius-app/pull/1823))
- Drop files into any composer ([#1750](https://github.com/CodiusAI/codius-app/pull/1750), [#1801](https://github.com/CodiusAI/codius-app/pull/1801))
- Show MiniMax usage in quota views ([#1662](https://github.com/CodiusAI/codius-app/pull/1662) by [@ilteoood](https://github.com/ilteoood))
- Highlight C# code blocks ([#1651](https://github.com/CodiusAI/codius-app/pull/1651) by [@dev693](https://github.com/dev693))

### Improved

- New Workspace opens from anywhere ([#1746](https://github.com/CodiusAI/codius-app/pull/1746), [#1806](https://github.com/CodiusAI/codius-app/pull/1806))
- Project search shows loading progress ([#1762](https://github.com/CodiusAI/codius-app/pull/1762))
- Desktop update checks show clearer status ([#1808](https://github.com/CodiusAI/codius-app/pull/1808), [#1815](https://github.com/CodiusAI/codius-app/pull/1815))
- Slow remote hosts time out less aggressively ([#1789](https://github.com/CodiusAI/codius-app/pull/1789))
- Pi waits longer for extension results ([#1732](https://github.com/CodiusAI/codius-app/pull/1732) by [@theslava](https://github.com/theslava))
- Open file tabs refresh when you revisit them ([#1699](https://github.com/CodiusAI/codius-app/pull/1699) by [@cleiter](https://github.com/cleiter))
- Web terminals scroll more smoothly ([#1622](https://github.com/CodiusAI/codius-app/pull/1622) by [@TommyLike](https://github.com/TommyLike))

### Fixed

- Freshly added projects can be edited without restarting ([#1761](https://github.com/CodiusAI/codius-app/pull/1761) by [@huiliaoning](https://github.com/huiliaoning))
- Large repos open more reliably ([#1620](https://github.com/CodiusAI/codius-app/pull/1620) by [@jms830](https://github.com/jms830))
- Mobile restores the saved workspace on launch ([#1777](https://github.com/CodiusAI/codius-app/pull/1777))
- Agent prompts no longer rename workspaces ([#1779](https://github.com/CodiusAI/codius-app/pull/1779))
- Chat stays put when delayed history arrives ([#1776](https://github.com/CodiusAI/codius-app/pull/1776))
- Streamed chat images stay in order ([#1805](https://github.com/CodiusAI/codius-app/pull/1805))
- Chat actions stay below tool output ([#1827](https://github.com/CodiusAI/codius-app/pull/1827))
- Claude subagent narration stays out of chat ([#1807](https://github.com/CodiusAI/codius-app/pull/1807))
- Kiro slash commands and skills appear in Codius ([#1792](https://github.com/CodiusAI/codius-app/pull/1792) by [@park0er](https://github.com/park0er))
- Agent lists survive stale project records ([#1812](https://github.com/CodiusAI/codius-app/pull/1812))
- Windows image previews handle drive-letter paths ([#1811](https://github.com/CodiusAI/codius-app/pull/1811))
- OpenCode closes cleanly on Windows ([#1771](https://github.com/CodiusAI/codius-app/pull/1771) by [@agamotto](https://github.com/agamotto))
- Desktop file uploads keep their extensions ([#1741](https://github.com/CodiusAI/codius-app/pull/1741))
- Claude Code cleanup kills child processes ([#1540](https://github.com/CodiusAI/codius-app/pull/1540) by [@TommyLike](https://github.com/TommyLike))
- OpenCode no longer indexes your home directory ([#1704](https://github.com/CodiusAI/codius-app/pull/1704) by [@rex-chang](https://github.com/rex-chang))
- Packaged macOS CLI daemon no longer shows extra Dock icons ([#1759](https://github.com/CodiusAI/codius-app/pull/1759) by [@yzim](https://github.com/yzim))
- `codius daemon status` works without loading agents ([#1810](https://github.com/CodiusAI/codius-app/pull/1810))
- PR worktrees show pushed state correctly ([#1804](https://github.com/CodiusAI/codius-app/pull/1804))

## 0.1.101 - 2026-06-26

### Added

- Copy a troubleshooting report from Settings when support needs host, daemon, provider, and log details ([#1728](https://github.com/CodiusAI/codius-app/pull/1728))
- Claude image tool results now render as images in chat ([#1717](https://github.com/CodiusAI/codius-app/pull/1717))
- Added Japanese ([#1694](https://github.com/CodiusAI/codius-app/pull/1694) by [@sysCat64](https://github.com/sysCat64))
- Added Brazilian Portuguese ([#1653](https://github.com/CodiusAI/codius-app/pull/1653) by [@Alcimerio](https://github.com/Alcimerio))

### Improved

- Provider diagnostics stay useful even when model discovery is slow ([#1724](https://github.com/CodiusAI/codius-app/pull/1724))
- Slow provider requests no longer make the app look disconnected ([#1723](https://github.com/CodiusAI/codius-app/pull/1723))
- Worktrees linked to differently named tracked branches find their PRs correctly ([#1718](https://github.com/CodiusAI/codius-app/pull/1718))
- Workspaces started from slash-command prompts get clearer names ([#1709](https://github.com/CodiusAI/codius-app/pull/1709))
- ACP provider catalog updated to the latest registry versions

### Fixed

- Pi no longer creates empty sessions while loading new-agent options ([#1727](https://github.com/CodiusAI/codius-app/pull/1727))
- Windows daemon status finds the daemon process more reliably ([#1725](https://github.com/CodiusAI/codius-app/pull/1725))
...
- Select a custom Copilot agent when starting or mid-session ([#1700](https://github.com/CodiusAI/codius-app/pull/1700))
...
- Claude no longer sends an extra API request after each message ([#1701](https://github.com/CodiusAI/codius-app/pull/1701))
- OpenCode no longer leaves stray background servers running after sessions end ([#1697](https://github.com/CodiusAI/codius-app/pull/1697))
- Slash commands and skills now load in OMP agents ([#1698](https://github.com/CodiusAI/codius-app/pull/1698))

## 0.1.99 - 2026-06-23

### Improved

- The PR panel now has a refresh button and clearer loading states ([#1664](https://github.com/CodiusAI/codius-app/pull/1664))
- Provider diagnostics and model lists now stay in sync ([#1660](https://github.com/CodiusAI/codius-app/pull/1660))

### Fixed

- ACP providers like Grok no longer show duplicate user messages
- Saved composer modes no longer reset while provider data is loading ([#1658](https://github.com/CodiusAI/codius-app/pull/1658))
- The right sidebar no longer gets stuck on mobile ([#1661](https://github.com/CodiusAI/codius-app/pull/1661))

## 0.1.98 - 2026-06-21

### Added

- See plan usage in-app for Claude, Codex, Copilot, Cursor, Z.AI, Grok, and Kimi ([#1278](https://github.com/CodiusAI/codius-app/pull/1278) by [@ABorakati](https://github.com/ABorakati))
- Added Ultracode for Claude ([#1625](https://github.com/CodiusAI/codius-app/pull/1625))
- Detach a subagent to run it on its own ([#1612](https://github.com/CodiusAI/codius-app/pull/1612))
...
- PR merge options name their method: squash, merge, or rebase ([#1608](https://github.com/CodiusAI/codius-app/pull/1608) by [@mcowger](https://github.com/mcowger))
- A running agent's mode change is remembered for new agents
- Copy a provider's launch diagnostic in one tap ([#1611](https://github.com/CodiusAI/codius-app/pull/1611))

### Fixed

- OpenCode no longer scans your whole disk on macOS desktop ([#1626](https://github.com/CodiusAI/codius-app/pull/1626))
- Daemon no longer crashes when OpenAI speech has no API key ([#1368](https://github.com/CodiusAI/codius-app/pull/1368) by [@mcowger](https://github.com/mcowger))
...
- OpenCode's mode picker now respects your disabled modes ([#1366](https://github.com/CodiusAI/codius-app/pull/1366) by [@mcowger](https://github.com/mcowger))
- File links and @-mentions find files in dot-folders and deep paths ([#1609](https://github.com/CodiusAI/codius-app/pull/1609))
- Archiving a project's last workspace no longer makes it vanish ([#1631](https://github.com/CodiusAI/codius-app/pull/1631))
...
- **Simplify workspace model** — run multiple workspaces on the same code without a worktree, each with its own agents, terminals, and status ([#1539](https://github.com/CodiusAI/codius-app/pull/1539))
- **Reopen archived workspaces from History** — restore a past workspace even after its worktree was removed
- **Terminals show when their agent is working, idle, or waiting for input** ([#1507](https://github.com/CodiusAI/codius-app/pull/1507))
- **Attach files to agents on mobile** ([#1501](https://github.com/CodiusAI/codius-app/pull/1501))
- **Hide dotfiles in the file explorer** ([#1516](https://github.com/CodiusAI/codius-app/pull/1516) by [@yuruiz](https://github.com/yuruiz))
- **Pin terminal, browser, and new-tab buttons to the tab row and sidebar**
- **Create a new workspace with a keyboard shortcut**

### Improved

- Workspace titles come from your first prompt and are shorter ([#1563](https://github.com/CodiusAI/codius-app/pull/1563))
- Copy a workspace's branch or path from its hover card
- Terminals stay smooth under heavy output ([#1500](https://github.com/CodiusAI/codius-app/pull/1500))
- Worktrees are removed when their last workspace is archived ([#1562](https://github.com/CodiusAI/codius-app/pull/1562))
- Finish notifications include subagent results ([#1558](https://github.com/CodiusAI/codius-app/pull/1558))
- Cursor lists only models you can select ([#1556](https://github.com/CodiusAI/codius-app/pull/1556))
- ACP provider catalog updated to the latest registry versions

### Fixed

- Brief daemon slowdowns no longer drop your connection
- Linux AppImage updates no longer hang on quit or delete the app ([#1485](https://github.com/CodiusAI/codius-app/pull/1485) by [@xpufx](https://github.com/xpufx))
- Opening Providers settings no longer crashes on Android ([#1537](https://github.com/CodiusAI/codius-app/pull/1537))
- Coding-agent terminal shortcuts work on Windows ([#1509](https://github.com/CodiusAI/codius-app/pull/1509))
- ACP and Kimi sessions can be imported again ([#1510](https://github.com/CodiusAI/codius-app/pull/1510) by [@wbxl2000](https://github.com/wbxl2000))
- ACP agents shut down without leaving orphaned processes ([#1460](https://github.com/CodiusAI/codius-app/pull/1460) by [@yeshan333](https://github.com/yeshan333))
- Imported session previews show clean prompts ([#1502](https://github.com/CodiusAI/codius-app/pull/1502))
- Local pairing offers use the correct app URL ([#1187](https://github.com/CodiusAI/codius-app/pull/1187) by [@aibaiiqpl](https://github.com/aibaiiqpl))
...
- Workspace shortcut numbers no longer appear for the wrong key ([#1580](https://github.com/CodiusAI/codius-app/pull/1580) by [@cleiter](https://github.com/cleiter))
- Chats no longer hang when a message contains unmatched backticks ([#1585](https://github.com/CodiusAI/codius-app/pull/1585) by [@thaning0](https://github.com/thaning0))
...
- **Attach any file to agents on desktop** ([#1474](https://github.com/CodiusAI/codius-app/pull/1474))

### Improved

- The git push button shows before merge actions when your branch is ahead ([#1488](https://github.com/CodiusAI/codius-app/pull/1488))
- SVG attachments are uploaded to disk
- Switching workspaces feels smoother

### Fixed

- Fixed cases where outdated GitHub data could be shown ([#1491](https://github.com/CodiusAI/codius-app/pull/1491))
- Uploaded images in PR comments and review threads now load in the PR panel ([#1486](https://github.com/CodiusAI/codius-app/pull/1486))
- Opening a project whose folder is missing shows a clear error ([#1490](https://github.com/CodiusAI/codius-app/pull/1490))
- The new workspace title moves out of the way of the keyboard ([#1489](https://github.com/CodiusAI/codius-app/pull/1489))
...
- **Attach pull request comments, reviews, threads, and failed check logs to chat from the PR panel** ([#1400](https://github.com/CodiusAI/codius-app/pull/1400))
- **Use Codius in Arabic, Chinese, English, French, Russian, and Spanish** ([#1282](https://github.com/CodiusAI/codius-app/pull/1282), [#1478](https://github.com/CodiusAI/codius-app/pull/1478) by [@chyendongnhanh338](https://github.com/chyendongnhanh338), [@dwyanewang](https://github.com/dwyanewang))
- **Create reusable terminal profiles from Host settings**
- **Open workspaces in Antigravity** ([#1424](https://github.com/CodiusAI/codius-app/pull/1424) by [@krumpyzoid](https://github.com/krumpyzoid))

### Improved

- Claude skills appear in prompt autocomplete as you type ([#1464](https://github.com/CodiusAI/codius-app/pull/1464))
- Copy file paths directly from file preview tab menus ([#1473](https://github.com/CodiusAI/codius-app/pull/1473))
- PR status stays current after an agent merges a branch ([#1455](https://github.com/CodiusAI/codius-app/pull/1455))
- Workspace tabs stay fast by retaining only the active workspace screens ([#1472](https://github.com/CodiusAI/codius-app/pull/1472))

### Fixed

- Composer send shortcuts no longer conflict with other keyboard shortcuts
- Multi-question prompts advance one answer at a time ([#1462](https://github.com/CodiusAI/codius-app/pull/1462))
- Imported Pi sessions keep their original model and thinking settings ([#1441](https://github.com/CodiusAI/codius-app/pull/1441) by [@thomasaull](https://github.com/thomasaull))
...
- **Claude Fable 5 is available in the Claude model picker** ([#1443](https://github.com/CodiusAI/codius-app/pull/1443) by [@0-Captain](https://github.com/0-Captain))
...
- Provider catalog is inline in Host settings ([#1423](https://github.com/CodiusAI/codius-app/pull/1423))
...
- Windows Explorer opens the selected workspace instead of Documents ([#1412](https://github.com/CodiusAI/codius-app/pull/1412) by [@bjspi](https://github.com/bjspi))
- Windows editor shortcuts installed as command shims launch correctly ([#1387](https://github.com/CodiusAI/codius-app/pull/1387) by [@Peter7896](https://github.com/Peter7896))
...
- **Open multiple desktop windows** ([#1355](https://github.com/CodiusAI/codius-app/pull/1355) by [@arieel-ost](https://github.com/arieel-ost))
- **Open browser pop-ups and links inside workspace tabs** ([#1375](https://github.com/CodiusAI/codius-app/pull/1375))
- **Use the command center from mobile**
- **Add OMP as a provider** ([#1388](https://github.com/CodiusAI/codius-app/pull/1388))
...
- Project search skips Python virtual environments ([#1356](https://github.com/CodiusAI/codius-app/pull/1356))
- Config files can include `$schema` for editor help
- Claude MCP servers preserve always-load tool settings ([#1333](https://github.com/CodiusAI/codius-app/pull/1333) by [@nodomain](https://github.com/nodomain))
- Claude profiles keep their configured models ([#1311](https://github.com/CodiusAI/codius-app/pull/1311) by [@ilteoood](https://github.com/ilteoood))
- Provider loading can wait longer on slow machines ([#1346](https://github.com/CodiusAI/codius-app/pull/1346) by [@nodomain](https://github.com/nodomain))
- The Kimi catalog entry now points to Kimi Code CLI ([#1403](https://github.com/CodiusAI/codius-app/pull/1403) by [@wbxl2000](https://github.com/wbxl2000))
...
- Local dictation crash reports show more useful details ([#1379](https://github.com/CodiusAI/codius-app/pull/1379))
- Daemon logs show why managed workers exit

### Fixed

- Pi compaction slash commands run correctly ([#1338](https://github.com/CodiusAI/codius-app/pull/1338) by [@chyendongnhanh338](https://github.com/chyendongnhanh338))
- Auto-archiving still works after a merged PR branch is deleted ([#1378](https://github.com/CodiusAI/codius-app/pull/1378))
- Worktrees can check out existing branch refs correctly ([#1358](https://github.com/CodiusAI/codius-app/pull/1358) by [@dixonl90](https://github.com/dixonl90))
- File downloads work when daemon password protection is enabled ([#1351](https://github.com/CodiusAI/codius-app/pull/1351) by [@nodomain](https://github.com/nodomain))
- iOS markdown links are tappable again ([#1334](https://github.com/CodiusAI/codius-app/pull/1334) by [@kaspesi](https://github.com/kaspesi))
- iOS markdown images render correctly
- Windows workspaces load their providers correctly ([#1329](https://github.com/CodiusAI/codius-app/pull/1329))
- Removing a localhost host stops its local daemon ([#1297](https://github.com/CodiusAI/codius-app/pull/1297) by [@mcowger](https://github.com/mcowger))
- Provider settings sheets stack correctly
- The new workspace screen no longer opens behind the mobile sidebar
- Global agent listing works again ([#1420](https://github.com/CodiusAI/codius-app/pull/1420))
...
- **Group the sidebar by status so workspaces waiting on you, ready to review, working, and done are visible at a glance** ([#1317](https://github.com/CodiusAI/codius-app/pull/1317))
- **Start a new workspace from the global sidebar button without choosing a project first** ([#1324](https://github.com/CodiusAI/codius-app/pull/1324))
- **Open the active file directly in your editor, file manager, or GitHub instead of only opening the workspace root** ([#1285](https://github.com/CodiusAI/codius-app/pull/1285) by [@aaronzhongg](https://github.com/aaronzhongg))
- **Automatically archive clean PR workspaces after the PR is merged from host settings** ([#1313](https://github.com/CodiusAI/codius-app/pull/1313))
- **Desktop-managed Codius skills stay current after installing a newer desktop build** ([#1309](https://github.com/CodiusAI/codius-app/pull/1309))
- **Dart files and Dart code blocks are now syntax-highlighted** ([#1326](https://github.com/CodiusAI/codius-app/pull/1326))

### Improved

- Sidebar workspaces can be marked as read when they are ready to review or failed ([#1317](https://github.com/CodiusAI/codius-app/pull/1317))
- Child agents keep unattended permissions when delegated across providers ([#1315](https://github.com/CodiusAI/codius-app/pull/1315))
- Scheduled agents open with the real prompt and title instead of looking empty ([#1316](https://github.com/CodiusAI/codius-app/pull/1316))
- Git controls prioritize the action that gets a ready branch shipped ([#1316](https://github.com/CodiusAI/codius-app/pull/1316))
...
- **Open workspace services through public service proxy links** ([#1280](https://github.com/CodiusAI/codius-app/pull/1280) by [@mcowger](https://github.com/mcowger))
- **Choose where new worktrees are created** ([#1230](https://github.com/CodiusAI/codius-app/pull/1230) by [@mcowger](https://github.com/mcowger))
- **Desktop windows reopen at the same size and position** ([#1224](https://github.com/CodiusAI/codius-app/pull/1224) by [@everton-dgn](https://github.com/everton-dgn))
...
- Archiving a worktree finishes even if teardown hits an error ([#1260](https://github.com/CodiusAI/codius-app/pull/1260) by [@mcowger](https://github.com/mcowger))
- iOS chat messages render bold, italics, strikethrough, and line breaks correctly ([#1254](https://github.com/CodiusAI/codius-app/pull/1254) by [@outofrange-consulting](https://github.com/outofrange-consulting))
- Right-edge split pane resizing no longer clips ([#1261](https://github.com/CodiusAI/codius-app/pull/1261) by [@everton-dgn](https://github.com/everton-dgn))
...
- **Keep cron schedules aligned to a chosen time zone** ([#1232](https://github.com/CodiusAI/codius-app/pull/1232) by [@damselem](https://github.com/damselem))
...
- macOS displays can idle normally while the desktop app is open ([#1242](https://github.com/CodiusAI/codius-app/pull/1242) by [@fireblue](https://github.com/fireblue))
...
- iOS chat messages no longer hide inline links, URLs, or linked file paths ([#1257](https://github.com/CodiusAI/codius-app/pull/1257) by [@outofrange-consulting](https://github.com/outofrange-consulting))
...
- Auto-generated agent titles and worktree branch names now use your configured provider fallbacks ([#1219](https://github.com/CodiusAI/codius-app/pull/1219) by [@mcowger](https://github.com/mcowger))
...
- Other agents connecting to Codius via MCP see the same providers, models, and modes as the app ([#1198](https://github.com/CodiusAI/codius-app/pull/1198))
...
- Allow selecting text in the chat on mobile ([#1153](https://github.com/CodiusAI/codius-app/pull/1153) by [@muzhi1991](https://github.com/muzhi1991))
- Submitting a Pi question no longer looks like a second prompt opened ([#1188](https://github.com/CodiusAI/codius-app/pull/1188) by [@yuruiz](https://github.com/yuruiz))
- Daemon memory leak from unbounded workspace git caches ([#1200](https://github.com/CodiusAI/codius-app/pull/1200))
- Provider diagnostics include the command override binary path ([#1191](https://github.com/CodiusAI/codius-app/pull/1191))
...
- **Rewind chat or files from any user message** ([#1154](https://github.com/CodiusAI/codius-app/pull/1154))
- **See the cumulative cost of an agent session** ([#1163](https://github.com/CodiusAI/codius-app/pull/1163))
- **Drop files onto the terminal to insert their paths** ([#1173](https://github.com/CodiusAI/codius-app/pull/1173))
- **Tap a file path in the terminal to open it in the workspace preview** ([#1174](https://github.com/CodiusAI/codius-app/pull/1174))
- **Approve OpenCode permissions for the whole session** ([#1168](https://github.com/CodiusAI/codius-app/pull/1168))
- **Workspace scripts now appear on the mobile header** ([#1093](https://github.com/CodiusAI/codius-app/pull/1093) by [@ayhanmalkoc](https://github.com/ayhanmalkoc))
...
- Tool activity for read, write, and OpenCode tools renders more consistently ([#1171](https://github.com/CodiusAI/codius-app/pull/1171))
- Compact workspace header actions are tidier
- Settings latency readouts are easier to scan ([#1170](https://github.com/CodiusAI/codius-app/pull/1170))
- Pull request merge is available as soon as GitHub reports the PR is ready ([#1172](https://github.com/CodiusAI/codius-app/pull/1172))

### Fixed

- Mobile slash command autocomplete no longer flickers or mis-layers
- Interrupting an OpenCode agent returns it to idle instead of showing an error ([#1169](https://github.com/CodiusAI/codius-app/pull/1169))
- Provider model selection per workspace is honored ([#1167](https://github.com/CodiusAI/codius-app/pull/1167))
- Draft composer keeps the permission mode you selected ([#1175](https://github.com/CodiusAI/codius-app/pull/1175))
...
- **Codius can now be installed as a web app from supported browsers** ([#1144](https://github.com/CodiusAI/codius-app/pull/1144))
- **Pi extension dialogs now appear as Codius permission prompts** ([#1134](https://github.com/CodiusAI/codius-app/pull/1134) by [@yuruiz](https://github.com/yuruiz))
- Added community links and a home button to the sidebar

### Improved

- **Mobile terminals load faster and restore existing output more smoothly** ([#1147](https://github.com/CodiusAI/codius-app/pull/1147))
...
- Worktree archive status no longer reports false unpushed commits ([#1158](https://github.com/CodiusAI/codius-app/pull/1158))
...
- **Rename workspaces, terminals, and agent tabs** ([#531](https://github.com/CodiusAI/codius-app/pull/531))
- **DeepSeek TUI in the ACP provider catalog** ([#1096](https://github.com/CodiusAI/codius-app/pull/1096))
- **Kiro CLI in the ACP provider catalog** (by [@huhusmang](https://github.com/huhusmang))
- Catalog providers show their icons in the model picker ([#1098](https://github.com/CodiusAI/codius-app/pull/1098))
- Custom environment variables passed when creating an agent now reach the agent process ([#1112](https://github.com/CodiusAI/codius-app/pull/1112))
- NixOS module supports the public TLS option for self-hosted relays ([#1106](https://github.com/CodiusAI/codius-app/pull/1106) by [@yzx9](https://github.com/yzx9))

### Improved

- **Stale host connections recover automatically without a manual refresh**
- Codius opens to the workspace you were on last time you used it ([#1101](https://github.com/CodiusAI/codius-app/pull/1101))
...
- Agent file-link tooltips show the full resolved file path ([#1088](https://github.com/CodiusAI/codius-app/pull/1088))
- Workspace git status refreshes less aggressively in the background ([#1102](https://github.com/CodiusAI/codius-app/pull/1102))

### Fixed

- macOS desktop no longer freezes after the display wakes from sleep ([#745](https://github.com/CodiusAI/codius-app/pull/745))
- Windows: Codex picks up the Microsoft Store install correctly ([#1020](https://github.com/CodiusAI/codius-app/pull/1020) by [@32r4](https://github.com/32r4))
- Workspace selection survives a daemon restart ([#1111](https://github.com/CodiusAI/codius-app/pull/1111))
- Cursor agents wait for slash commands to load before listing them ([#1099](https://github.com/CodiusAI/codius-app/pull/1099) by [@chrisbanes](https://github.com/chrisbanes))
...
- Duplicate Claude result text no longer appears in chat ([#1095](https://github.com/CodiusAI/codius-app/pull/1095))
- Dynamic UI styles no longer leak CSS rules across the page ([#1103](https://github.com/CodiusAI/codius-app/pull/1103))
- Relay handshakes reject sessions that try to change encryption keys mid-flight ([#1037](https://github.com/CodiusAI/codius-app/pull/1037) by [@joaosa](https://github.com/joaosa))
...
- **Configurable terminal scrollback** ([#1021](https://github.com/CodiusAI/codius-app/pull/1021) by [@32r4](https://github.com/32r4))
- Assistant file links open at a specific line range when one is included
- Mode icons appear in the agent status menu ([#1059](https://github.com/CodiusAI/codius-app/pull/1059) by [@32r4](https://github.com/32r4))
- MCP exposes schedule update, logs, and run-once tools ([#1032](https://github.com/CodiusAI/codius-app/pull/1032) by [@skevetter](https://github.com/skevetter))
- Self-hosted relays can use a different TLS setting for the public endpoint ([#1045](https://github.com/CodiusAI/codius-app/pull/1045) by [@yzx9](https://github.com/yzx9))
...
- Native diff rows expand correctly ([#940](https://github.com/CodiusAI/codius-app/pull/940) by [@bolasblack](https://github.com/bolasblack))
- Mobile sidebar interactions work correctly on web ([#900](https://github.com/CodiusAI/codius-app/pull/900) by [@nikuscs](https://github.com/nikuscs))
- Mobile web drag gestures fire reliably ([#1048](https://github.com/CodiusAI/codius-app/pull/1048) by [@nikuscs](https://github.com/nikuscs))
- Mobile web drag-and-drop activates correctly ([#1048](https://github.com/CodiusAI/codius-app/pull/1048) by [@nikuscs](https://github.com/nikuscs))
- iOS Safari no longer zooms when focusing the composer ([#1048](https://github.com/CodiusAI/codius-app/pull/1048) by [@nikuscs](https://github.com/nikuscs))
- Enter behavior in the mobile web composer is consistent ([#1048](https://github.com/CodiusAI/codius-app/pull/1048) by [@nikuscs](https://github.com/nikuscs))
- Composer no longer flickers when resizing with long prompts
- Inline code links in assistant messages open the correct file
- Host switcher popover is wide enough to show host names ([#981](https://github.com/CodiusAI/codius-app/pull/981) by [@kongjiadongyuan](https://github.com/kongjiadongyuan))
- Windows: importing existing sessions matches paths correctly ([#1012](https://github.com/CodiusAI/codius-app/pull/1012) by [@kj1534](https://github.com/kj1534))
...
- **Auto Review permission mode for Claude Code and Codex** Agents stop after each assistant turn for review instead of running unattended ([#928](https://github.com/CodiusAI/codius-app/pull/928), [#963](https://github.com/CodiusAI/codius-app/pull/963) by [@bolasblack](https://github.com/bolasblack))
...
- Allow setting fast mode for Codius subagents ([#909](https://github.com/CodiusAI/codius-app/pull/909), [#910](https://github.com/CodiusAI/codius-app/pull/910) by [@kongjiadongyuan](https://github.com/kongjiadongyuan))
...
- New workspace flow honors the currently checked-out branch when branching off ([#909](https://github.com/CodiusAI/codius-app/pull/908) by [@sbtobb](https://github.com/sbtobb))
- OpenCode models from console subscription providers now appear in the model picker ([#917](https://github.com/CodiusAI/codius-app/pull/917) by [@t2o2](https://github.com/t2o2))
- Cursor model picker reflects the models advertised by the Cursor ACP client ([#958](https://github.com/CodiusAI/codius-app/pull/958) by [@chrisbanes](https://github.com/chrisbanes))

### Fixed

- iPad hardware Enter submits the composer ([#919](https://github.com/CodiusAI/codius-app/pull/919) by [@kongjiadongyuan](https://github.com/kongjiadongyuan))
- PR status falls back to a non-checks query for fine-grained GitHub tokens ([#932](https://github.com/CodiusAI/codius-app/pull/932) by [@32r4](https://github.com/32r4))
...
- MCP worktree cache refreshes after create and archive ([#911](https://github.com/CodiusAI/codius-app/pull/911) by [@kongjiadongyuan](https://github.com/kongjiadongyuan))

## 0.1.75 - 2026-05-12

### Added

- Set the speech-to-text language used by dictation and voice mode from settings ([#941](https://github.com/CodiusAI/codius-app/pull/941))

### Fixed

- Codex resume failures now surface as explicit errors instead of leaving the agent silently stuck ([#947](https://github.com/CodiusAI/codius-app/pull/947))
- Custom providers extending Codex now route correctly when they set a custom `OPENAI_BASE_URL` ([#915](https://github.com/CodiusAI/codius-app/pull/915))
- Fixed Copilot's **Allow All** mode (renamed from Autopilot) ([#935](https://github.com/CodiusAI/codius-app/pull/935))
- Desktop: daemon startup no longer fails when a stale PID file is left next to a still-running daemon ([#913](https://github.com/CodiusAI/codius-app/pull/913) by [@biaoma-ty](https://github.com/biaoma-ty))
- iPhone HEIC photos now attach correctly from the image picker ([#934](https://github.com/CodiusAI/codius-app/pull/934))
- Scheduled agents now archive automatically after each run ([#945](https://github.com/CodiusAI/codius-app/pull/945))
- Windows: Codex command summaries trim `pwsh`, `powershell`, or `cmd` wrappers ([#931](https://github.com/CodiusAI/codius-app/pull/931) by [@32r4](https://github.com/32r4))
- iPad: settings sidebar and main sidebar respect the top safe area in wide layouts ([#922](https://github.com/CodiusAI/codius-app/pull/922), [#937](https://github.com/CodiusAI/codius-app/pull/937) by [@kongjiadongyuan](https://github.com/kongjiadongyuan))

## 0.1.74 - 2026-05-11

### Fixed

- **OpenCode agent turns no longer stall** Codius now follows OpenCode's global event stream, so turns stream reliably without falling back to fragile recovery paths ([#916](https://github.com/CodiusAI/codius-app/pull/916))

## 0.1.73 - 2026-05-10

### Fixed

- **OpenCode agents work again on OpenCode 1.14.42+** ([#895](https://github.com/CodiusAI/codius-app/pull/895), [#902](https://github.com/CodiusAI/codius-app/pull/902), [#904](https://github.com/CodiusAI/codius-app/pull/904) by [@atomlink-ye](https://github.com/atomlink-ye), [@plutofog](https://github.com/plutofog))
- Web: opening a workspace no longer hangs in browsers without `crypto.randomUUID` ([#858](https://github.com/CodiusAI/codius-app/pull/858) by [@cokekitten](https://github.com/cokekitten))
- Codex sub-agent child tool calls now report a final failure state instead of staying as "running" ([#899](https://github.com/CodiusAI/codius-app/pull/899))
- Old relay pairing URLs without an explicit TLS flag work again ([#896](https://github.com/CodiusAI/codius-app/pull/896))
- macOS: the tab-jump shortcut no longer collides with system shortcuts ([#859](https://github.com/CodiusAI/codius-app/pull/859) by [@nikuscs](https://github.com/nikuscs))
- Web: the composer no longer triggers a bottom-sheet keyboard on desktop browsers ([#898](https://github.com/CodiusAI/codius-app/pull/898) by [@nikuscs](https://github.com/nikuscs))
- Windows: git operations no longer flash a console window on each invocation ([#897](https://github.com/CodiusAI/codius-app/pull/897))
- File explorer no longer follows symlinks outside the workspace root ([#847](https://github.com/CodiusAI/codius-app/pull/847) by [@joaosa](https://github.com/joaosa))
- Desktop only opens external URLs via http(s) and mailto schemes ([#845](https://github.com/CodiusAI/codius-app/pull/845) by [@joaosa](https://github.com/joaosa))
- MCP debug request logs now redact request bodies ([#842](https://github.com/CodiusAI/codius-app/pull/842) by [@joaosa](https://github.com/joaosa))

## 0.1.72 - 2026-05-10

### Fixed

- **Codex approval prompts no longer hang** Fixes a regression introduced in 0.1.70 where Codex agents would wait forever on command and file approvals — the prompt never reached the app and the agent stayed stuck in "running" ([#866](https://github.com/CodiusAI/codius-app/pull/866), [#869](https://github.com/CodiusAI/codius-app/pull/869))
- **Windows: daemon no longer crashes when Codex emits non-JSON output** Localized stdout lines from the Codex CLI are now ignored instead of taking down the daemon worker ([#866](https://github.com/CodiusAI/codius-app/pull/866))
- Drag-and-drop images onto the new workspace screen now works ([#850](https://github.com/CodiusAI/codius-app/pull/850))
- Archiving a worktree from the toolbar redirects you immediately instead of leaving you on the dead screen for a beat ([#852](https://github.com/CodiusAI/codius-app/pull/852))
- Pi-backed sessions now shut down cleanly when you close them, releasing extension resources on the Pi side ([#863](https://github.com/CodiusAI/codius-app/pull/863))

## 0.1.71 - 2026-05-09

### Added

- **Import existing Claude, Codex, and OpenCode sessions** into Codius — pick up a conversation you started in the terminal and keep going from the app, with the full timeline ([#766](https://github.com/CodiusAI/codius-app/pull/766), [#833](https://github.com/CodiusAI/codius-app/pull/833))
- **Subagents now appear in a collapsible section above the composer** so you can jump into agents your main agent spawned ([#532](https://github.com/CodiusAI/codius-app/pull/532))
- Merge a pull request directly from the checkout pane ([#814](https://github.com/CodiusAI/codius-app/pull/814))
- Customize the per-project prompts Codius uses to auto-generate agent titles, branch names, commit messages, and pull request descriptions ([#836](https://github.com/CodiusAI/codius-app/pull/836))
- Open an empty workspace without typing a prompt first ([#834](https://github.com/CodiusAI/codius-app/pull/834))
- Project settings are now grouped with inline links to the relevant docs ([#837](https://github.com/CodiusAI/codius-app/pull/837))
- Rich context menu on desktop — copy link, copy image, and spellcheck suggestions
- Archiving a Codex-backed agent now archives the underlying native Codex thread too ([#827](https://github.com/CodiusAI/codius-app/pull/827) by [@32r4](https://github.com/32r4))

### Improved

- Opening a workspace auto-focuses the agent that needs your attention ([#828](https://github.com/CodiusAI/codius-app/pull/828))
...
- iOS project picker now submits the typed path ([#831](https://github.com/CodiusAI/codius-app/pull/831))
- System messages and chat mentions routed to multiple agents now reach every recipient consistently ([#830](https://github.com/CodiusAI/codius-app/pull/830))
...
- Local state files (daemon keypair, stored credentials, persisted config) are now readable only by the owning user ([#825](https://github.com/CodiusAI/codius-app/pull/825) by [@joaosa](https://github.com/joaosa))
...
- **Linux:** Workspace file watchers no longer storm with events on busy working trees, fixing CPU spikes on large repos ([#794](https://github.com/CodiusAI/codius-app/pull/794) by [@312223105](https://github.com/312223105))
- ACP-based agents launch terminal shell commands reliably ([#793](https://github.com/CodiusAI/codius-app/pull/793) by [@ebg1223](https://github.com/ebg1223))
...
- Creating an agent in a subdirectory of a registered workspace now runs in that subdirectory instead of jumping up to the parent ([#551](https://github.com/CodiusAI/codius-app/issues/551))
- Non-GitHub project display names are derived from the remote owner/repo instead of the local path
- Desktop IPC wrapped in shared mutation/query hooks, fixing stale state and intermittent failures ([#761](https://github.com/CodiusAI/codius-app/issues/761))
...
- Answering an interactive question from a Claude agent now reaches Claude correctly instead of being dropped ([#760](https://github.com/CodiusAI/codius-app/pull/760) by [@somus](https://github.com/somus))
...
- **In-app browser** — open a real web browser in any workspace to test your app ([#670](https://github.com/CodiusAI/codius-app/pull/670) by [@jasonkneen](https://github.com/jasonkneen))
- Inline review comments in the git diff pane. Tap a line number to start a comment ([#530](https://github.com/CodiusAI/codius-app/pull/530))
- Sub-agent activity is now shown for Codex, OpenCode, and Claude ([#672](https://github.com/CodiusAI/codius-app/pull/672), [#658](https://github.com/CodiusAI/codius-app/pull/658) by [@thisisryanswift](https://github.com/thisisryanswift))
...
- **Apple Silicon Mac:** The desktop update pipeline now publishes manifests atomically, closing a race that could install the Intel build on Apple Silicon Macs and cause 100%+ renderer CPU usage. Affected users will self-heal — electron-updater's Rosetta detection migrates back to arm64 on the next update poll ([#555](https://github.com/CodiusAI/codius-app/issues/555))
- **Linux:** `.deb` and `.rpm` packages now show as `Codius` in the dock and process list instead of `Codius.bin`. `--no-sandbox` is now scoped to AppImage only, matching VS Code's sandbox handling ([#602](https://github.com/CodiusAI/codius-app/issues/602))
- **Windows:** Git diff commands no longer break on paths with special characters ([#629](https://github.com/CodiusAI/codius-app/pull/629))
- Cursor CLI and other ACP custom providers launch reliably ([#628](https://github.com/CodiusAI/codius-app/pull/628))
- Daemon stays up when WebSocket clients disconnect mid-stream, and crashes now write a fatal log entry instead of disappearing silently ([#613](https://github.com/CodiusAI/codius-app/pull/613) by [@yuruiz](https://github.com/yuruiz))
- Long agent timelines reconnect cleanly over the relay instead of looping through disconnects while catching up ([#657](https://github.com/CodiusAI/codius-app/pull/657) by [@fireblue](https://github.com/fireblue))
...
- OpenCode mode picker now lists agents available in every mode ([#606](https://github.com/CodiusAI/codius-app/pull/606) by [@thisisryanswift](https://github.com/thisisryanswift))
...
- Archived worktrees stay hidden without flashing back into the list ([#640](https://github.com/CodiusAI/codius-app/pull/640))
...
- Streamed agent output reconciles cleanly when the timeline hydrates mid-turn ([#663](https://github.com/CodiusAI/codius-app/pull/663))
...
- OpenCode now has a Full Access mode that auto-approves tool calls ([#595](https://github.com/CodiusAI/codius-app/pull/595) by [@tmih06](https://github.com/tmih06))
- OpenCode supports executable slash commands ([#597](https://github.com/CodiusAI/codius-app/pull/597) by [@tmih06](https://github.com/tmih06))

### Improved

- `@`-mention stays responsive on very large projects ([#600](https://github.com/CodiusAI/codius-app/pull/600) by [@yuruiz](https://github.com/yuruiz))
...
- Open the current branch on GitHub from a workspace's open menu ([#583](https://github.com/CodiusAI/codius-app/pull/583) by [@Myriad-Dreamin](https://github.com/Myriad-Dreamin))
...
- Voice mode transcription endpoint is configurable for OpenAI-compatible providers ([#570](https://github.com/CodiusAI/codius-app/pull/570) by [@yuruiz](https://github.com/yuruiz))
...
- `codius loop run` and `codius run` now respect the `--provider` and `--model` flags ([#594](https://github.com/CodiusAI/codius-app/pull/594) by [@VincenzoRocchi](https://github.com/VincenzoRocchi))
...
- Codex keeps fast mode after you approve a plan ([#526](https://github.com/CodiusAI/codius-app/pull/526) by [@therainisme](https://github.com/therainisme))
...
- Markdown files render as formatted markdown in the file pane ([#427](https://github.com/CodiusAI/codius-app/pull/427) by [@aaronflorey](https://github.com/aaronflorey))
- Cmd+L (Ctrl+L on Windows/Linux) focuses the agent message input
- Provider models refresh on a freshness TTL; Settings shows last-updated time and any fetch errors ([#426](https://github.com/CodiusAI/codius-app/pull/426))
- `disallowedTools` option in provider config to block specific tools from an agent

### Improved

- Windows: agents launch reliably from npm `.cmd` shims, paths with spaces, and JSON config args — fixes `spawn EINVAL` startup errors ([#454](https://github.com/CodiusAI/codius-app/pull/454))
- OpenCode permission prompts include the requesting tool's context ([#398](https://github.com/CodiusAI/codius-app/pull/398) by [@aaronflorey](https://github.com/aaronflorey))
...
- Code file previews can be selected and copied on iOS ([#447](https://github.com/CodiusAI/codius-app/pull/447) by [@muzhi1991](https://github.com/muzhi1991))
- File preview no longer shows stale content when reopening the same file ([#411](https://github.com/CodiusAI/codius-app/pull/411) by [@muzhi1991](https://github.com/muzhi1991))
- File explorer reinitialises when the client reconnects after a page refresh ([#442](https://github.com/CodiusAI/codius-app/pull/442) by [@1996fanrui](https://github.com/1996fanrui))
- Generic ACP providers no longer receive duplicated command arguments ([#444](https://github.com/CodiusAI/codius-app/pull/444) by [@edvardchen](https://github.com/edvardchen))
...
- Provider profiles — define custom providers in your Codius config that appear alongside built-ins. Override a built-in's binary, env, or models, or create entirely new providers. See the [configuration guide](https://github.com/CodiusAI/codius-app/blob/main/docs/custom-providers.md)
