# Contributing to Codius

Codius is an opinionated product maintained by one person right now.
...
Explain the problem you want to solve: your use case, where Codius falls short today, and the flow you expect.
