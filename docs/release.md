...
approval; Codius remains on major version zero until that deliberate decision.
...
```jsonc
// mcp__codius__create_heartbeat arguments
{
...
The changelog is shown on the Codius homepage. Write it for **end users**, not developers.
