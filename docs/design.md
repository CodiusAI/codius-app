...
Codius is minimal, spacious, quiet, confident. Whitespace is deliberate. Nothing crowds, nothing decorates, nothing apologizes. A row, a label, a control. That is the bar.
...
Sentence case. "Pair a device", "Danger zone", "Restart daemon", "Inject Codius tools", "No sessions yet", "Load more". Proper nouns retain casing — Codius, Beta, Stable, Local. Title case is wrong.
