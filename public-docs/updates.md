---
title: Updates
description: How Codius releases work, the difference between stable and beta channels, and how to opt in to earlier updates.
nav: Updates
order: 5
...
Codius ships updates through two channels: **Stable** and **Beta**.
...
Codius follows [Semantic Versioning](https://semver.org) with prerelease tags.
...
There is no beta channel in the app stores right now — only stable builds are submitted. If you want early Android builds, download the APK from the [GitHub releases page](https://github.com/prismosoft/codius-desktop/releases).
