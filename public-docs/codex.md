---
title: Codex
description: Run Codex in Codius using the official Codex CLI and your existing OpenAI account.
nav: Codex
order: 24
category: Providers
---
...
## Does Codex cost extra in Codius?

No. Codius does not add a charge for Codex. Sign in to the Codex CLI with ChatGPT to use the access included with your ChatGPT plan, or sign in with an API key for usage billed through your OpenAI Platform account.

Your plan's normal Codex limits and OpenAI's standard API pricing still apply.

## Getting started

Install the [Codex CLI](https://learn.chatgpt.com/docs/codex/cli) on the machine running Codius:
...
Codius uses this installation and its existing authentication when you start a Codex agent.
...
- [Codius vs Codex app](/alternatives/codex-app), for a feature comparison.
