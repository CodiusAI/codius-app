---
title: Why Codius?
description: What Codius is, what it isn't, and how it fits into your workflow.
nav: Why Codius?
order: 2
...
Codius is a self-hostable platform for running and orchestrating coding agents. It runs the agent CLIs you already use, on the hardware you already have, and gives you a UI, CLI, and API to drive them from anywhere.
...
- [Codius tools](/docs/orchestration). Agents can drive Codius themselves: create isolated workspaces, spawn subagents, open terminals, and send prompts.
