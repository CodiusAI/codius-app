...
OUT_DIR="/tmp/codius-workspace-create-android-focus-$(date +%s)"
VIDEO_DIR="/tmp/codius-maestro-videos"
DEVICE_VIDEO="/sdcard/codius-maestro-workspace-create-focused.mp4"
