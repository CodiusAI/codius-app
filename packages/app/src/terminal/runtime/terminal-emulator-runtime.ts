...
} from "@codius-ai/protocol/terminal-input-mode";
import {
...
export class TerminalEmulatorRuntime {
  ...
  mount(input: TerminalEmulatorRuntimeMountInput): void {
    ...
    window.__codiusTerminal = terminal;
  ...
  unmount(): void {
    ...
    this.cleanup?.();
    this.cleanup = null;
    if (window.__codiusTerminal === this.terminal) {
      window.__codiusTerminal = undefined;
    }
    this.terminal = null;
    this.fitAddon = null;
