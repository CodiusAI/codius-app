...
declare global {
  interface Window {
    ...
    __CODIUS_TERMINAL_WEBVIEW_RECEIVE__?: (message: InboundMessage) => void;
    __CODIUS_TERMINAL_WEBVIEW_BLUR__?: () => void;
  }
}
...
const TERMINAL_BACKGROUND_CSS_VAR = "--codius-terminal-background";
...
window.__CODIUS_TERMINAL_WEBVIEW_RECEIVE__ = bridge.receive;
window.__CODIUS_TERMINAL_WEBVIEW_BLUR__ = bridge.blur;
