...
import type { CodiusSubagentRow, ProviderSubagentRow, SubagentRow } from "./select";
import {
...
function row(
  overrides: Partial<CodiusSubagentRow> & Pick<CodiusSubagentRow, "id">,
): CodiusSubagentRow {
  return {
    kind: "codius",
    id: overrides.id,
