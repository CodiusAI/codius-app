...
const RELEASE_DOWNLOAD_BASE_URL = "https://github.com/prismosoft/codius-desktop/releases/download";
...
export function buildMacAppleSiliconDownloadUrl(version: string | null | undefined): string | null {
  ...
  return `${RELEASE_DOWNLOAD_BASE_URL}/v${normalizedVersion}/Codius-${normalizedVersion}-arm64.dmg`;
}
