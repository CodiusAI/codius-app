...
describe("parseAssistantFileLink", () => {
  ...
  it("keeps tilde hrefs as direct home-relative file targets", () => {
    expect(
      parseAssistantFileLink("~/.codius/plans/file-preview.md", {
        workspaceRoot: "/Users/test/project",
      }),
    ).toEqual({
      raw: "~/.codius/plans/file-preview.md",
      path: "~/.codius/plans/file-preview.md",
      lineStart: undefined,
      lineEnd: undefined,
    });
    expect(
      parseAssistantFileLink("~/.codius/plans/file-preview.md:12", {
        workspaceRoot: "/Users/test/project",
      }),
    ).toEqual({
      raw: "~/.codius/plans/file-preview.md:12",
      path: "~/.codius/plans/file-preview.md",
      lineStart: 12,
      lineEnd: undefined,
    });
...
describe("normalizeInlinePathTarget", () => {
  ...
  it("keeps tilde paths as home-relative file targets", () => {
    expect(
      normalizeInlinePathTarget("~/.codius/plans/file-preview.md", "/Users/test/project"),
    ).toEqual({
      directory: "~/.codius/plans",
      file: "~/.codius/plans/file-preview.md",
    });
  });
