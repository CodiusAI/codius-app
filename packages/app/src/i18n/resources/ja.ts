...
export const ja: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "このワークスペースはCodiusワークツリーとして作成されていないため、アーカイブはここでは利用できません",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        title: "組み込みデーモンを管理",
        hint: "Codiusが組み込みデーモンを起動・停止できるようにする",
        pauseTitle: "組み込みデーモンを一時停止",
        pauseMessage:
          "これにより組み込みデーモンが即座に停止します。組み込みデーモンに接続されている実行中のエージェントとターミナルが停止されます。",
        pauseAndStop: "一時停止して停止",
        registrationFailed:
          "組み込みデーモンは起動しましたが、Codiusがlocalhostの接続を保存できませんでした。デーモン管理をオフにしてから再度オンにするか、localhostを手動で追加してください。",
        pausedStopFailed:
          "組み込みデーモン管理は一時停止されましたが、Codiusがデーモンを停止できませんでした。",
        updateFailed: "組み込みデーモン管理を更新できません。",
      },
      keepRunning: {
        title: "終了後もデーモンを実行し続ける",
        hint: "Codiusを終了してもデーモンは実行し続けます",
      },
      logs: {
        title: "ログファイル",
        modalTitle: "デーモンログ",
      ...
      fullStatus: {
        ...
        hint: "`codius daemon status`を実行して出力を表示します",
        view: "ステータスを表示",
    ...
    rosetta: {
      ...
      runningIntel: "Apple Silicon上のRosettaでCodiusのIntelビルドを実行しています。",
      highCpu:
  ...
  pairing: {
    ...
    direct: {
      title: "直接接続",
      helper: "Codiusサーバーのアドレスを入力してください。",
      fields: {
        host: "ホスト",
        port: "ポート",
        password: "パスワード",
    ...
    device: {
      ...
      relayDocs: "リレーの仕組み",
      relayDocsAccessibility: "Codius リレーの仕組みを読む",
      enableRelay: "リレーを有効にする",
      enablingRelay: "有効化中...",
      notNow: "今はしない",
      directConnectionHint:
        "リレーを使わない場合は、TCP、Tailscale、または別の VPN で直接接続してください。QR コードは作成されません。",
      updateRequired: "Codius Desktop からリレーを有効にするにはホストを更新してください。",
      unavailable: "ペアリングオファーが利用できません。",
      hint: "スマートフォンのCodiusでこのQRコードをスキャンするか、以下のリンクをコピーしてください。",
  ...
  toolCallGroup: {
    ...
    codiusCalls: {
      one: "Codiusを{{count}}回呼び出し",
      other: "Codiusを{{count}}回呼び出し",
    },
    and: "および",
  },
  renameModal: {
  ...
  settings: {
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "このコンピューターのCodiusを更新します",
    ...
    integrations: {
      ...
      skills: {
        ...
        uninstallTitle: "Codiusスキルをアンインストールしますか？",
        uninstallMessage:
          "~/.agents、~/.claude、~/.codexからすべてのCodiusオーケストレーションスキルを削除します。",
        choose: "スキルを選択",
        chooseAll: "すべてのスキル",
        chooseAllHint:
    ...
    host: {
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Codiusツールを有効にする",
          hint: "エージェントがワークツリー、エージェント、スケジュールを管理できるようになります",
          accessibilityLabel: "Codiusツールを有効にする",
        },
        systemPrompt: {
          title: "システムプロンプト",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "このホストはオフラインです。Codiusが自動再接続します。再起動は、ホストがオンラインに戻ってから行ってください。",
          requestFailedTitle: "エラー",
          requestFailedMessage:
            "再起動リクエストの送信に失敗しました。Codiusは自動的に再接続します。ホストがオンラインになったら再試行してください。",
    ...
    project: {
      ...
      readFailures: {
        invalidTitle: "codius.jsonを解析できませんでした",
        ...
        transportTitle: "codius.jsonを読み込めませんでした",
        transportFallback: "ホストが応答しませんでした。",
        failedTitle: "codius.jsonを読み込めませんでした",
      ...
      scripts: {
        ...
        serviceHint: "Codiusがプロセスを監督し、$CODIUS_PORTを通じてポートを割り当てます",
        actions: {
          add: "スクリプトを追加",
          edit: "編集",
          remove: "削除",
      ...
      metadata: {
        title: "メタデータ生成",
        info: "Codiusがメタデータ生成に使うAIプロンプトへ追加する、プロジェクト固有の指示です。ブランチ名、コミット形式、PR形式など、チームの規約を反映するために使います。",
        branchName: "ブランチ名",
      ...
      writeFailures: {
        ...
        staleDescription: "保存する前に最新のcodius.jsonを取得するために再読み込みしてください。",
        failedTitle: "codius.jsonを保存できませんでした",
