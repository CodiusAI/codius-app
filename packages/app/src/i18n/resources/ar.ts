...
export const ar: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "الأرشيف غير متاح هنا لأنه لم يتم إنشاء مساحة العمل هذه كشجرة عمل Codius",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "اسمح لـ Codius ببدء تشغيل البرنامج الخفي المدمج وإيقافه",
        ...
        pausedStopFailed:
          "تم إيقاف إدارة البرنامج الخفي المضمنة مؤقتًا، لكن لم يتمكن Codius من إيقاف البرنامج الخفي.",
        updateFailed: "غير قادر على تحديث إدارة البرنامج الخفي المضمنة.",
      },
      keepRunning: {
        title: "استمر في تشغيل البرنامج الخفي بعد الإقلاع عن التدخين",
        hint: "يستمر تشغيل Daemon عند إنهاء Codius",
      },
      logs: {
        title: "ملف السجل",
      ...
      fullStatus: {
        ...
        hint: "يقوم بتشغيل`codius daemon status`ويظهر الإخراج",
        view: "عرض الحالة",
    ...
    rosetta: {
      ...
      runningIntel: "أنت تقوم بتشغيل إصدار Intel من Codius ضمن Rosetta على Apple Silicon.",
      highCpu:
  ...
  pairing: {
    ...
    device: {
      ...
      relayDocsAccessibility: "اقرأ كيفية عمل تتابع Codius",
      ...
      updateRequired: "حدّث المضيف لتمكين التتابع من Codius Desktop.",
      unavailable: "عرض الاقتران غير متاح.",
      hint: "قم بمسح رمز QR هذا باستخدام Codius على هاتفك، أو انسخ الرابط أدناه.",
  ...
  toolCallGroup: {
    ...
    codiusCalls: {
      one: "استدعى Codius {{count}} مرة",
      other: "استدعى Codius {{count}} مرات",
    },
    and: "و",
  },
  renameModal: {
  ...
  settings: {
    ...
    general: {
      ...
      browserData: {
        ...
        description: "تتشارك علامات تبويب المتصفح تسجيلات الدخول وبيانات المواقع عبر Codius.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "يؤدي هذا إلى تحديث Codius على هذا الكمبيوتر",
    ...
    integrations: {
      ...
      skills: {
        ...
        uninstallTitle: "إلغاء تثبيت مهارات Codius ؟",
        uninstallMessage: "يزيل جميع مهارات تنسيق Codius من ~/.agents ، ~/.claude ، ~/.codex.",
    ...
    host: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "هذا المضيف غير متصل.  يقوم Codius بإعادة الاتصال تلقائيًا - انتظر حتى يتم الاتصال بالإنترنت مرة أخرى قبل إعادة التشغيل.",
          requestFailedTitle: "خطأ",
          requestFailedMessage:
            "فشل في إرسال طلب إعادة التشغيل.  يقوم Codius بإعادة الاتصال تلقائيًا - حاول مرة أخرى بمجرد ظهور المضيف على أنه متصل بالإنترنت.",
    ...
    project: {
      ...
      readFailures: {
        invalidTitle: "تعذر تحليل codius.json",
        ...
        transportTitle: "تعذر تحميل codius.json",
        transportFallback: "المضيف لم يستجب.",
        failedTitle: "تعذر تحميل codius.json",
      ...
      scripts: {
        ...
        serviceHint: "يشرف Codius على العملية ويعين منفذًا عبر $CODIUS_PORT",
        actions: {
      ...
      metadata: {
        ...
        info: "تعليمات خاصة بالمشروع يتم إدخالها في الذكاء الاصطناعي الذي يستخدمه Codius لإنشاء بيانات التعريف - استخدمها لفرض اصطلاحات فريقك مثل تسمية الفرع أو نمط الالتزام أو تنسيق PR",
      ...
      writeFailures: {
        ...
        staleDescription: "أعد التحميل لجلب أحدث ملف codius.json قبل الحفظ.",
        failedTitle: "تعذر حفظ codius.json",
