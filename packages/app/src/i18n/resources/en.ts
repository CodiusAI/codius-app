export const en = {
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Let Codius start and stop the built-in daemon",
        ...
        pausedStopFailed:
          "Built-in daemon management was paused, but Codius could not stop the daemon.",
        updateFailed: "Unable to update built-in daemon management.",
      },
      keepRunning: {
        title: "Keep daemon running after quit",
        hint: "Daemon keeps running when you quit Codius",
      },
      logs: {
        title: "Log file",
      ...
      fullStatus: {
        ...
        hint: "Runs `codius daemon status` and shows the output",
        view: "View status",
    ...
    rosetta: {
      ...
      runningIntel: "You're running the Intel build of Codius under Rosetta on Apple Silicon.",
  ...
  rootError: {
    ...
    title: "Codius ran into a problem.",
  ...
  pairing: {
    ...
    direct: {
      title: "Direct connection",
      helper: "Enter the address of a Codius server.",
      fields: {
        host: "Host",
        port: "Port",
        password: "Password",
    ...
    device: {
      ...
      relayDocsAccessibility: "Read how Codius relay works",
      ...
      updateRequired: "Update the host to enable relay from Codius Desktop.",
      unavailable: "Pairing offer unavailable.",
      hint: "Scan this QR code with Codius on your phone, or copy the link below.",
  ...
  toolCallGroup: {
    ...
    codiusCalls: {
      one: "called Codius {{count}} time",
      other: "called Codius {{count}} times",
    },
    and: "and",
  },
  renameModal: {
  ...
  settings: {
    ...
    general: {
      ...
      browserData: {
        ...
        description: "Browser tabs share sign-ins and site data across Codius.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "This updates Codius on this computer",
    ...
    integrations: {
      ...
      skills: {
        ...
        uninstallTitle: "Uninstall Codius skills?",
        uninstallMessage:
          "Removes all Codius orchestration skills from ~/.agents, ~/.claude, ~/.codex.",
    ...
    host: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "This host is offline. Codius reconnects automatically-wait until it's back online before restarting.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "Failed to send the restart request. Codius reconnects automatically-try again once the host shows as online.",
    ...
    project: {
      ...
      readFailures: {
        invalidTitle: "codius.json couldn't be parsed",
        ...
        transportTitle: "Couldn't load codius.json",
        transportFallback: "The host didn't respond.",
        failedTitle: "Couldn't load codius.json",
      ...
      scripts: {
        ...
        serviceHint: "Codius supervises the process and assigns a port via $CODIUS_PORT",
        actions: {
          add: "Add script",
          edit: "Edit",
          remove: "Remove",
      ...
      metadata: {
        ...
        info: "Project-specific instructions injected into the AI prompts Codius uses to generate metadata - use them to enforce your team's conventions like branch naming, commit style, or PR format",
      ...
      writeFailures: {
        ...
        staleDescription: "Reload to fetch the latest codius.json before saving.",
        failedTitle: "Couldn't save codius.json",
