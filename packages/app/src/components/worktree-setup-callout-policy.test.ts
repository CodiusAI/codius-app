...
describe("shouldShowWorktreeSetupCallout", () => {
  it("shows the callout when codius config was read and setup commands are missing", () => {
  ...
  it("does not show the callout when reading codius config fails or has not completed", () => {
