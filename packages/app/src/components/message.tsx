...
const WEB_TOOLCALL_SHIMMER_KEYFRAME_ID = "codius-toolcall-shimmer-keyframes";
const WEB_TOOLCALL_SHIMMER_ANIMATION_NAME = "codius-toolcall-shimmer";
...
const WEB_TOOLCALL_SHIMMER_KEYFRAME_CSS = `
  @keyframes ${WEB_TOOLCALL_SHIMMER_ANIMATION_NAME} {
    0% {
      background-position: var(--codius-shimmer-start, -200px) 0;
    }
    100% {
      background-position: var(--codius-shimmer-end, 200px) 0;
    }
  }
`;
...
function buildShimmerTextStyle(input: {
  ...
  return inlineUnistylesStyle({
    ...
    "--codius-shimmer-start": `${input.webShimmerTrackStart - input.offsetX}px`,
    "--codius-shimmer-end": `${input.webShimmerTrackEnd - input.offsetX}px`,
  });
}
