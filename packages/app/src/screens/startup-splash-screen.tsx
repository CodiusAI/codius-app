...
const WEB_SPLASH_SHIMMER_KEYFRAME_ID = "codius-splash-shimmer-keyframes";
const WEB_SPLASH_SHIMMER_ANIMATION_NAME = "codius-splash-shimmer";
  ...
  const maskElement = useMemo(
    () => (
      <View style={styles.shimmerMask}>
        <CodiusLogo size={LOGO_SIZE} color="#000000" />
      </View>
    ),
    [],
  );
    ...
    <MaskedView style={trackStyle} maskElement={maskElement}>
      <View style={trackStyle}>
        <View style={styles.nativeShimmerBase}>
          <CodiusLogo size={LOGO_SIZE} color={color} />
        </View>
