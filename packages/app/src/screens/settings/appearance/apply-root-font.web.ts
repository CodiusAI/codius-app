...
const STYLE_ID = "codius-ui-font";
const RULE =
  ":is(#root, #overlay-root) *:not([data-pmono]):not([data-pmono] *){font-family:var(--codius-ui-font);}";
...
export function applyRootUiFont(uiFontStack: string): void {
  ...
  document.documentElement.style.setProperty("--codius-ui-font", value);
