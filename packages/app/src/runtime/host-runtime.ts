...
import { ConnectionOfferSchema, type ConnectionOffer } from "@codius.ai/protocol/connection-offer";
...
const REGISTRY_STORAGE_KEY = "@codius:daemon-registry";
const LOCALHOST_FALLBACK_ENDPOINT = "localhost:6767";
const DEFAULT_LOCALHOST_BOOTSTRAP_TIMEOUT_MS = 2500;
const E2E_STORAGE_KEY = "@codius:e2e";
const INITIAL_DAEMON_CONNECTION_HINT_GLOBAL_KEY = "__CODIUS_INITIAL_DAEMON_CONNECTION__";
...
const HOST_RUNTIME_STORE_GLOBAL_KEY = "__codiusHostRuntimeStore";
