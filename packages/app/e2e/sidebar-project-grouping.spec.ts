...
const GROUPED_PROJECT_NAME = "codius-e2e/grouped-project";
const SHARED_REMOTE_URL = "https://github.com/codius-e2e/grouped-project.git";
...
async function removePersistedProjectKeys(host: IsolatedHostDaemon): Promise<void> {
  const projectsPath = path.join(host.codiusHome, "projects", "projects.json");
