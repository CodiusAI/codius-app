import { readCodiusConfigJson } from "./codius-config-file.js";
import {
  CodiusConfigSchema,
...
// owner replaces it wholesale via codius.json metadataGeneration.<configKey>.instructions
...
async function readProjectMetadataOverrides(
...
): Promise<CodiusMetadataGeneration | undefined> {
  ...
  try {
    ...
    return CodiusConfigSchema.parse(json).metadataGeneration;
  } catch {
    return undefined;
  }
}
