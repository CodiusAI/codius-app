...
export class DaemonConfigStore {
  ...
  public patch(partial: MutableDaemonConfigPatch): MutableDaemonConfig {
    ...
    if (parsedPatch.relay?.enabled !== undefined && !this.relayEnabledMutable) {
      throw new Error(
        "Relay is controlled by a daemon launch override. Remove CODIUS_RELAY_ENABLED or the relay CLI flag before changing it here.",
      );
    }
    ...
    try {
      ...
      savePersistedConfig(this.codiusHome, persistedBeforePatch, this.logger);
      throw error;
    }
