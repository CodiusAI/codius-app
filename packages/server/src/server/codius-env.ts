...
export type CodiusNodeEnv = "development" | "production" | "test";
...
export function createCodiusInternalEnv(baseEnv: NodeJS.ProcessEnv): NodeJS.ProcessEnv {
...
export function resolveCodiusNodeEnv(env: NodeJS.ProcessEnv): CodiusNodeEnv | undefined {
  const value = env[CODIUS_NODE_ENV];
