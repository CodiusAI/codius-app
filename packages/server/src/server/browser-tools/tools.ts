...
const WORKSPACE_CONTEXT_MESSAGE =
  "This browser tool needs a workspace. Start the agent from a Codius workspace before calling browser_new_tab or browser_list_tabs.";
...
export function registerBrowserTools(options: RegisterBrowserToolsOptions): void {
  options.registerTool(
    "browser_list_tabs",
    {
      ...
      description:
        "List open Codius browser tabs for this agent's workspace across connected browser automation hosts. Use returned browserId values with tab-scoped tools.",
      inputSchema: {},
    },
    async () => {
  ...
  options.registerTool(
    "browser_new_tab",
    {
      ...
      description:
        "Create a new Codius browser tab in this agent's workspace on the most recently connected browser automation host, opened in the background without switching the user's view. Pass an http(s) URL or a scheme-less host URL, which is treated as http; the returned browserId is used by tab-scoped tools.",
      inputSchema: {
  ...
  options.registerTool(
    "browser_snapshot",
    {
      ...
      description:
        "Return a model-readable snapshot of a Codius browser tab. Use browserId from browser_new_tab or browser_list_tabs; refs come from the latest browser_snapshot of the same tab and expire when the page changes.",
      inputSchema: {
        browserId: BrowserAutomationBrowserIdSchema,
      },
    },
  ...
  options.registerTool(
    "browser_click",
    {
      ...
      description:
        "Click an element in a Codius browser tab. Use browserId from browser_new_tab or browser_list_tabs; refs come from the latest browser_snapshot of the same tab and expire when the page changes.",
      inputSchema: {
  ...
  options.registerTool(
    "browser_fill",
    {
      ...
      description:
        "Fill an input-like element in a Codius browser tab. Use browserId from browser_new_tab or browser_list_tabs; refs come from the latest browser_snapshot of the same tab and expire when the page changes.",
      inputSchema: {
        ref: BrowserRefInputSchema,
        value: z.string(),
        browserId: BrowserAutomationBrowserIdSchema,
  ...
  options.registerTool(
    "browser_wait",
    {
      ...
      description:
        "Wait until a Codius browser tab contains text or reaches a URL fragment. Use browserId from browser_new_tab or browser_list_tabs; waits up to 5s by default on the browser host.",
  ...
  options.registerTool(
    "browser_navigate",
    {
      ...
      description:
        "Navigate a Codius browser tab to a URL. Use browserId from browser_new_tab or browser_list_tabs; pass an http(s) URL or a scheme-less host URL, which is treated as http.",
  ...
  for (const toolConfig of [
    {
      ...
      title: "Browser back",
      description:
        "Go back in a Codius browser tab. Use browserId from browser_new_tab or browser_list_tabs.",
    },
    {
      ...
      description:
        "Go forward in a Codius browser tab. Use browserId from browser_new_tab or browser_list_tabs.",
    },
    {
      name: "browser_reload",
      command: "reload",
      ...
      description:
        "Reload a Codius browser tab. Use browserId from browser_new_tab or browser_list_tabs.",
    },
  ] as const) {
    options.registerTool(
      toolConfig.name,
  ...
  options.registerTool(
    "browser_screenshot",
    {
      ...
      description:
        "Capture a PNG screenshot of a Codius browser tab. Use browserId from browser_new_tab or browser_list_tabs. Set fullPage to true to capture the full page.",
      inputSchema: {
        browserId: BrowserAutomationBrowserIdSchema,
  ...
  options.registerTool(
    "browser_upload",
    {
      ...
      description:
        "Set workspace files on a file input in a Codius browser tab. Use browserId from browser_new_tab or browser_list_tabs; refs come from the latest browser_snapshot of the same tab and expire when the page changes.",
      inputSchema: {
        ref: BrowserRefInputSchema,
  ...
  for (const toolConfig of [
    {
      ...
      description:
        "Hover an element in a Codius browser tab. Use browserId from browser_new_tab or browser_list_tabs; refs come from the latest browser_snapshot of the same tab and expire when the page changes.",
    },
  ] as const) {
    options.registerTool(
      toolConfig.name,
  ...
  options.registerTool(
    "browser_select",
    {
      ...
      description:
        "Set a select element in a Codius browser tab to a value. Use browserId from browser_new_tab or browser_list_tabs; refs come from the latest browser_snapshot of the same tab and expire when the page changes.",
      inputSchema: {
        ref: BrowserRefInputSchema,
        value: z.string(),
        browserId: BrowserAutomationBrowserIdSchema,
  ...
  options.registerTool(
    "browser_drag",
    {
      ...
      description:
        "Drag one element onto another in a Codius browser tab. Use browserId from browser_new_tab or browser_list_tabs; refs come from the latest browser_snapshot of the same tab and expire when the page changes.",
      inputSchema: {
  ...
  options.registerTool(
    "browser_logs",
    {
      ...
      description:
        "Read recent console messages and browser performance network entries for a Codius browser tab. Use browserId from browser_new_tab or browser_list_tabs; maxEntries defaults to 50.",
      inputSchema: {
  ...
  options.registerTool(
    "browser_evaluate",
    {
      ...
      description:
        "Evaluate a JavaScript function in a Codius browser tab. Use browserId from browser_new_tab or browser_list_tabs; when ref is provided, refs come from the latest browser_snapshot and the resolved element is passed as the first argument.",
      inputSchema: {
  ...
  options.registerTool(
    "browser_scroll",
    {
      ...
      description:
        "Scroll a Codius browser tab by deltaX/deltaY CSS pixels. Use browserId from browser_new_tab or browser_list_tabs; optional ref comes from the latest browser_snapshot and centers the wheel input over that element.",
      inputSchema: {
        browserId: BrowserAutomationBrowserIdSchema,
        ref: BrowserRefInputSchema.optional(),
        deltaX: z.number(),
  ...
  options.registerTool(
    "browser_resize",
    {
      ...
      description:
        "Resize a Codius browser tab's resident webview viewport. Use browserId from browser_new_tab or browser_list_tabs.",
      inputSchema: {
        browserId: BrowserAutomationBrowserIdSchema,
  ...
  options.registerTool(
    "browser_close_tab",
    {
      ...
      description:
        "Close a Codius browser tab, remove its resident webview, and unregister it from the browser automation host. Use browserId from browser_new_tab or browser_list_tabs.",
      inputSchema: {
        browserId: BrowserAutomationBrowserIdSchema,
      },
    },
...
function browserToolImageContent(
  result: Extract<BrowserToolsResponsePayload, { ok: true }>["result"],
): CodiusToolResult["content"][number] | null {
  if (result.command !== "screenshot") {
    return null;
  }
...
function summarizeBrowserSuccess(
  ...
  if (payload.result.command === "list_tabs") {
    ...
    if (count === 0) {
      return "No Codius browser tabs are open. Call browser_new_tab to create one.";
    }
    ...
    return withDialogs(
      [
        `Found ${count} Codius browser tab${count === 1 ? "" : "s"}. Use these browserId values for tab-scoped browser tools.`,
        ...tabLines,
      ].join("\n"),
    );
  }
