...
describe("bootstrapWorkspaceRegistries", () => {
  ...
  beforeEach(() => {
    ...
    codiusHome = path.join(tmpDir, ".codius");
    agentStorage = new AgentStorage(path.join(codiusHome, "agents"), logger);
    projectRegistry = new FileBackedProjectRegistry(
      path.join(codiusHome, "projects", "projects.json"),
      logger,
    );
    workspaceRegistry = new FileBackedWorkspaceRegistry(
      path.join(codiusHome, "projects", "workspaces.json"),
      logger,
    );
