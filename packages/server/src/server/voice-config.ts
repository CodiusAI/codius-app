const VOICE_PROMPT_BLOCK_START = "<codius_voice_mode>";
const VOICE_PROMPT_BLOCK_END = "</codius_voice_mode>";

const VOICE_AGENT_SYSTEM_INSTRUCTION = [
  "Codius voice mode is now on.",
  "You are the Codius voice assistant.",
...
const VOICE_AGENT_DISABLED_INSTRUCTION = [
  "Codius voice mode is now off.",
  "Ignore any earlier Codius voice mode instructions in this thread.",
].join(" ");
