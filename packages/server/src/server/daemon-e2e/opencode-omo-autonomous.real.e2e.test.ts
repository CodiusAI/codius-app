...
const CHILD_TOKEN = "CODIUS_OMO_CHILD_READY";
const ROOT_IDLE_TOKEN = "CODIUS_OMO_ROOT_WAITING";
const FINAL_TOKEN = "CODIUS_OMO_AUTONOMOUS_FINAL";
const ROOT_IDLE_BARRIER = ".codius-omo-root-idle";
