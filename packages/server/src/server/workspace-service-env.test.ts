...
describe("buildWorkspaceServiceEnv", () => {
  ...
  it("builds default branch self and service URLs", () => {
    expect(
      ...
      HOST: "127.0.0.1",
      CODIUS_PORT: "5173",
      CODIUS_URL: "http://daemon--codius.localhost:6767",
      CODIUS_SERVICE_DAEMON_PORT: "5173",
      CODIUS_SERVICE_DAEMON_URL: "http://daemon--codius.localhost:6767",
    });
  });
  ...
  it("builds feature branch self and service URLs", () => {
    expect(
      ...
      HOST: "127.0.0.1",
      CODIUS_PORT: "5173",
      CODIUS_URL: "http://daemon--feature-x--codius.localhost:6767",
      CODIUS_SERVICE_DAEMON_PORT: "5173",
      CODIUS_SERVICE_DAEMON_URL: "http://daemon--feature-x--codius.localhost:6767",
    });
  });

  it("omits PORT while keeping CODIUS_PORT", () => {
    ...
    expect(env.CODIUS_PORT).toBe("5173");
  ...
  it("adds peer service ports and URLs", () => {
    expect(
      ...
      HOST: "127.0.0.1",
      CODIUS_PORT: "5173",
      CODIUS_URL: "http://web--feature-x--codius.localhost:6767",
      CODIUS_SERVICE_API_PORT: "4000",
      CODIUS_SERVICE_API_URL: "http://api--feature-x--codius.localhost:6767",
      CODIUS_SERVICE_WEB_PORT: "5173",
      CODIUS_SERVICE_WEB_URL: "http://web--feature-x--codius.localhost:6767",
    });
  });
  ...
  it("uses public service URLs when a public base URL is configured", () => {
    expect(
      ...
      CODIUS_URL: "https://web--feature-x--codius.services.example.com",
      CODIUS_SERVICE_API_URL: "https://api--feature-x--codius.services.example.com",
      CODIUS_SERVICE_WEB_URL: "https://web--feature-x--codius.services.example.com",
    });
  });
