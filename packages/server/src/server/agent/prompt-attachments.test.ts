  ...
  it("renders GitLab change request attachments with MR numbering", () => {
    expect(
      renderPromptAttachmentAsText({
        ...
        mimeType: "application/codius-forge-change-request",
        forge: "gitlab",
        number: 123,
        title: "Fix race in worktree setup",
        url: "https://gitlab.com/prismosoft/codius-desktop/-/merge_requests/123",
        body: "MR body",
