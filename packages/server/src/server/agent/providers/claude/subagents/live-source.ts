 ...
 *
 * Verified on the wire (Claude Code 2.1.220, Codius's own query options):
 *
...
export class ClaudeTaskProtocolSource {
   ...
   * value Codius requested is not necessarily the one that ran, because a model that does not
