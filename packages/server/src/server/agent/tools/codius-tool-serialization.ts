...
import type { CodiusToolDefinition, CodiusToolResult } from "./types.js";
...
export function addModelVisibleStructuredContent(result: CodiusToolResult): CodiusToolResult {
...
export function serializeCodiusToolInputParameters(
  tool: CodiusToolDefinition,
