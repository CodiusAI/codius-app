...
export CODIUS_HOME="${CODIUS_HOME:-$PASEO_HOME}"
export PASEO_HOME="$CODIUS_HOME"

DEV_ROOT="${CODIUS_DEV_ROOT:-${PASEO_DEV_ROOT:-$(default_dev_paseo_root)}}"
export CODIUS_ELECTRON_USER_DATA_DIR="${CODIUS_ELECTRON_USER_DATA_DIR:-${PASEO_ELECTRON_USER_DATA_DIR:-$DEV_ROOT/.dev/user-data}}"
export PASEO_ELECTRON_USER_DATA_DIR="$CODIUS_ELECTRON_USER_DATA_DIR"
...
REMOTE_DEBUGGING_PORT="${CODIUS_ELECTRON_REMOTE_DEBUGGING_PORT:-${PASEO_ELECTRON_REMOTE_DEBUGGING_PORT:-9223}}"
