...
const TIMEOUT_ENV_KEY = "CODIUS_SHELL_ENV_TIMEOUT_MS";
...
function resolveShellEnv({ deps, timeoutMs }: ResolveShellEnvInput): ResolvedShellEnv {
  ...
  delete shellEnv.CODIUS_NODE_ENV;
  delete shellEnv.CODIUS_DESKTOP_MANAGED;
  delete shellEnv.CODIUS_SUPERVISED;
