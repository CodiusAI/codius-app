...
const MANIFEST_OWNER = "codius-skills-transaction";
const MANIFEST_FILENAME = "transaction.json";
const TRANSACTION_PREFIX = ".codius-skills-transaction-";
const RECOVERED_PREFIX = ".codius-skills-recovered-";
const BACKUP_DIRNAME = "backup";
const MANAGED_FILES_MANIFEST = ".codius-managed-files.json";
