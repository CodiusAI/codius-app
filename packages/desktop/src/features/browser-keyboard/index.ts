...
import { CodiusBrowserWebviewRegistry } from "../browser-webviews/registry.js";
import {
...
const POLICY_INPUT_CHANNEL = "codius:browser:set-shortcut-policy";
const POLICY_OUTPUT_CHANNEL = "codius:browser-keyboard-policy";
const POLICY_REQUEST_CHANNEL = "codius:browser-keyboard-policy-request";
const SHORTCUT_INPUT_CHANNEL = "codius:browser-shortcut-input";
const SHORTCUT_OUTPUT_CHANNEL = "codius:event:browser-shortcut-input";
const RESERVED_SHORTCUT_OUTPUT_CHANNEL = "codius:event:browser-shortcut";
...
export class BrowserKeyboard {
  ...
  public constructor(private readonly browserRegistry: CodiusBrowserWebviewRegistry) {}
