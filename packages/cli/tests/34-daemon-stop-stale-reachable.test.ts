...
/**
 * Regression: `codius daemon stop` must stop a reachable daemon even when the
...
try {
  ...
  console.log(
    "Test 2: `codius daemon stop` should stop reachable worker instead of saying not_running",
  );
  const stopResult =
