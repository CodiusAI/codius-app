...
const existingProject = join(await mkdtemp(join(tmpdir(), "codius-open-project-")), "project");
...
const previousDesktopCli = process.env.CODIUS_DESKTOP_CLI;
process.env.CODIUS_DESKTOP_CLI = "1";
...
process.env.CODIUS_DESKTOP_CLI = previousDesktopCli;
