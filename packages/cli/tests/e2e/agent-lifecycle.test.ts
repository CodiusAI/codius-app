...
async function setup(): Promise<void> {
  ...
  try {
    ...
    console.log(`CODIUS_HOME: ${ctx.codiusHome}`);
...
async function test_agent_ls_empty(): Promise<void> {
  ...
  const result = await ctx.codius(["ls", "--json"]);
...
async function test_agent_wait(agentId: string): Promise<void> {
  ...
  const result = await ctx.codius(["wait", "--timeout", "120s", agentId], { timeout: 130000 });
...
async function test_agent_inspect(agentId: string): Promise<void> {
  ...
  const result = await ctx.codius(["inspect", agentId]);
...
async function test_agent_logs(agentId: string): Promise<void> {
  ...
  const result = await ctx.codius(["logs", "--tail", "20", agentId]);
...
async function test_agent_stop(agentId: string): Promise<void> {
  ...
  const result = await ctx.codius(["stop", agentId]);
  ...
  const inspectResult = await ctx.codius(["inspect", agentId]);
...
async function test_agent_delete(agentId: string): Promise<void> {
  ...
  const result = await ctx.codius(["delete", agentId]);
