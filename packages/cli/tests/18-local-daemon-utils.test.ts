...

{
  ...
  assert.strictEqual(resolveTcpHostFromListen("/tmp/codius.sock"), null);
  assert.strictEqual(resolveTcpHostFromListen("unix:///tmp/codius.sock"), null);
  assert.strictEqual(resolveTcpHostFromListen("pipe://\\\\.\\pipe\\codius-managed-test"), null);
  assert.strictEqual(resolveTcpHostFromListen("\\\\.\\pipe\\codius-managed-test"), null);
...

{
  ...
  assert.strictEqual(resolveTcpHostFromListen("C:\\Users\\foo\\.codius\\codius.sock"), null);
  assert.strictEqual(resolveTcpHostFromListen("D:\\project\\socket"), null);
  assert.strictEqual(resolveTcpHostFromListen("C:\\codius.sock"), null);
