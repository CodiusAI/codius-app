 ...
 * - `codius agent ls`    → active non-archived agents
 * - `codius agent ls -g` → global non-archived agents
 * - `codius agent ls -a` → active agents, including archived
 * - `codius agent ls -ag` → global agents, including archived
 */
