...
describe("shouldUseTlsForDefaultHostedRelay", () => {
  test("returns true for the hosted Codius relay on port 443", () => {
    expect(shouldUseTlsForDefaultHostedRelay("relay.codius.ai:443")).toBe(true);
  });
