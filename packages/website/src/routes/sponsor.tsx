...
export const Route = createFileRoute("/sponsor")({
  head: () =>
    pageMeta(
      "Sponsor Codius",
      "Support the independent open-source project behind Codius. Built by Mo, funded by the community.",
      "/sponsor",
    ),
  component: Sponsor,
});
  ...
  return (
    <SiteShell width="default">
      ...
      <div className="space-y-6 text-white/70 leading-relaxed max-w-2xl">
        ...
        <p>
          Codius started as a personal project: I wanted to run coding agents from anywhere without
        ...
        <p>
          I work on Codius full-time. It&apos;s an independent, self-funded open-source project. I
      ...
      <section className="mt-12 space-y-4">
        <h2 className="text-xl font-medium">Support Codius</h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <a
            href="https://opencollective.com/codius-ai/donate?interval=month&amount=10&contributeAs=me"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-4 rounded-xl border border-white/10 bg-white/[0.03] p-5 hover:border-white/20 hover:bg-white/[0.05] transition-colors"
          >
          ...
          <a
            href="https://buymeacoffee.com/codius"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-4 rounded-xl border border-white/10 bg-white/[0.03] p-5 hover:border-white/20 hover:bg-white/[0.05] transition-colors"
          >
