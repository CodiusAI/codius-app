...
export const Route = createFileRoute("/cloud")({
  head: () =>
    pageMeta(
      "Codius Cloud - Design Partners",
      "Run Codius across machines, with a team, or inside a company. We're onboarding design partners for the hosted, multi-machine, multi-user version of Codius.",
      "/cloud",
    ),
  component: Cloud,
});
...
function Cloud() {
  return (
    <SiteShell width="default">
      <h1 className="text-3xl font-medium mb-3">Codius Cloud</h1>
      <p className="text-white/70 leading-relaxed mb-10">
        For using Codius across machines, with a team, or inside a company. Looking for design
        partners.
      </p>
    ...
    <form onSubmit={handleSubmit} className="space-y-6" noValidate>
      ...
      <Field label="Message" required>
        <textarea
          ...
          required
          rows={5}
          placeholder="A bit about you and what you'd want from Codius Cloud."
  ...
  return (
    <section className="space-y-6">
      ...
      <div className="space-y-6">
        <FAQItem question="What is Codius Cloud?">
          An optional layer on top of Codius for running daemons across machines, syncing config
          between them, and using Codius with a team or company. Think shared runners, permissions,
          audit, managed daemons, and org controls.
        </FAQItem>
        <FAQItem question="Will Codius stay free and open source?">
        ...
        <FAQItem question="Self-hosted or managed?">
          Both. The control plane will live in the Codius monorepo so you can host it yourself.
          Managed is for people and teams who don&apos;t want to.
        </FAQItem>
        <FAQItem question="Does my code go through Codius?">
