...
export const Route = createFileRoute("/privacy")({
  head: () =>
    pageMeta(
      "Privacy Policy - Codius",
      "Privacy policy for Codius, the self-hosted coding agent manager. No tracking, no analytics, no data collection. Your code stays on your machine.",
      "/privacy",
    ),
  component: Privacy,
});
  ...
  return (
    <SiteShell width="default">
      ...
      <div className="space-y-6 text-white/70 leading-relaxed">
        <p>
          Codius is a self-hosted tool for managing coding agents. Your code and data stay on your
          machine.
        </p>

        <section className="space-y-3">
          <h2 className="text-xl font-medium text-white">What we collect</h2>
          <p>Nothing. Codius runs on your machine and doesn&apos;t send us any data.</p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            Codius wraps agent providers like Claude Code, Codex, and OpenCode. Those tools
            communicate with their own APIs (Anthropic, OpenAI, etc.) using your credentials. Codius
        ...
        <section className="space-y-3">
          ...
          <p>We don&apos;t have your data to sell. Codius is self-hosted and local-first.</p>
        </section>
