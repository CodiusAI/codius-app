...
export const Route = createFileRoute("/docs/")({
  head: () => {
    ...
    if (!doc)
      return pageMeta(
        "Docs - Codius",
        "Install Codius and start running coding agents from your phone, desktop, and terminal.",
        "/docs",
      );
    return pageMeta(`${doc.frontmatter.title} - Codius Docs`, doc.frontmatter.description, "/docs");
  },
  component: DocsIndex,
});
