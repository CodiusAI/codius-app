...
const SOCIAL_PROOF_TWEETS = [
  ...
  },
  {
    ...
    text: "Codius is a really good interface for Pi. It’s not the only thing it does, but that’s my current use case for now.",
  },
  {
    name: "Dong",
    handle: "@dongnaebi",
    ...
    text: "Codius is the best software I've used this year. Absolutely amazing!",
  },
] as const;
  ...
  return (
    ...
    >
      <SectionTitle
        ...
        description="See what developers are saying about Codius."
      />
...
function MultiProviderSection() {
  ...
  return (
    <FeatureSection
      ...
      description="Run your agents from one interface. Codius uses each provider's native harness, so your subscriptions, skills, config, and MCP servers keep working."
    >
...
function WorkflowSection() {
  return (
    <FeatureSection
      ...
      description="Create branches, preview the app in the browser, review the diff inline, then commit, open a PR, and merge without leaving Codius."
    >
...
function ServiceProxySection() {
  ...
  return (
    <FeatureSection
      ...
      description="When agents work in parallel, they all run dev servers. Codius gives each one a URL based on the branch name, no port conflicts, no guessing."
    >
...
const SERVER_INSTALL_FOOTNOTE = (
  <>
    Requires Node.js 18+. Run <span className="font-mono text-white/40">codius</span> to start the
    daemon.
  </>
);
...
function ServerInstallButton() {
  return (
    <CommandDialog
      ...
      description="For headless machines you want to connect to from the Codius apps. The desktop app already includes a built-in daemon."
      command="npm install -g @codius-ai/cli && codius"
...
const bashCommands = new Set(["codius", "echo", "jq"]);
...
const cliExamples: CLIExample[] = [
  {
    ...
    code: `codius run "implement user authentication"
codius run --provider codex --worktree feature-x "implement feature X"
codius run --host devbox:6767 "run the full test suite"

codius ls                           # list running agents
codius attach abc123                # stream live output
codius send abc123 "also add tests" # follow-up task`,
  },
  {
    title: "Loops",
    description:
...
codius loop run "make all tests pass" \\
  --verify "verify tests pass and the code is production-ready" \\
  --verify-check "npm test" \\
  --max-iterations 5

codius loop ls                        # list running loops
codius loop logs abc123               # stream loop output`,
  },
  {
    title: "Schedules",
    description:
...
codius schedule create --cron "0 9 * * 1" \\
  "audit the codebase for security issues and open PRs for fixes"

codius schedule ls                    # list all schedules
codius schedule pause abc123          # pause a schedule
codius schedule delete abc123         # remove a schedule`,
  },
];
    ...
    >
      ...
      <div className="space-y-6">
        <FAQItem question="Is this free?">
          Yes. Codius is free and open source. You need Claude Code, Codex, Cursor, OpenCode, or Pi
        ...
        <FAQItem question="Does my code leave my machine?">
          Codius doesn&apos;t send your code anywhere. Agents run locally and talk to their own APIs
        ...
        <FAQItem question="What agents does it support?">
          ...
          own CLI or local integration. Codius doesn&apos;t modify or wrap their behavior.
        </FAQItem>
        <FAQItem question="Do I need the desktop app?">
          No. You can run the daemon headless with{" "}
          <code className="font-mono text-muted-foreground">
            npm install -g @codius-ai/cli && codius
          </code>{" "}
        ...
        <FAQItem question="Can I connect from outside my network?">
          Yes. You can use the hosted relay (end-to-end encrypted, Codius can&apos;t read your
        ...
        <FAQItem question="Do I need git or GitHub?">
          No. Codius works in any directory. Worktrees are optional and only relevant if you use
          git. You can run agents anywhere you&apos;d normally work.
        </FAQItem>
        <FAQItem question="Can I get banned for using Codius?">
          <p>We can&apos;t make promises on behalf of providers.</p>
          <p>
            That said, Codius launches each provider&apos;s local CLI or integration (Claude Code,
            Codex, Cursor, OpenCode, Pi) as a subprocess. It doesn&apos;t extract tokens or call
            inference APIs directly. From the provider&apos;s perspective, usage through Codius is
            indistinguishable from running the provider yourself.
          </p>
          <p>I&apos;ve been using Codius with all providers for months without issue.</p>
        </FAQItem>
        <FAQItem question="How do worktrees work?">
          When you launch an agent with the worktree option (from the app, desktop, or CLI), Codius
  ...
  return (
    ...
    >
      <div className="text-sm text-muted-foreground leading-relaxed space-y-3">
        <p>
          Codius is an independent open source project for running coding agents across your own
        ...
        <p>If you like Codius, sponsorship is the best way to support continued development.</p>
        <p>- Mo</p>
      </div>
      <div className="pt-2">
        <a
